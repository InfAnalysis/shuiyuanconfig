...
(async () => {
  ...
  const EXPAND_RETORT_USERS_ICON =
    /* solid circle-chevron-down */ '<svg class="d-icon svg-icon" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M256 0a256 256 0 1 0 0 512A256 256 0 1 0 256 0zM135 241c-9.4-9.4-9.4-24.6 0-33.9s24.6-9.4 33.9 0l87 87 87-87c9.4-9.4 24.6-9.4 33.9 0s9.4 24.6 0 33.9L273 345c-9.4 9.4-24.6 9.4-33.9 0L135 241z"/></svg>';
  ...
  const INSPECT_TOPIC_ICON =
    /* solid magnifying-glass */ '<svg class="d-icon svg-icon" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M416 208c0 45.9-14.9 88.3-40 122.7L502.6 457.4c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L330.7 376c-34.4 25.2-76.8 40-122.7 40C93.1 416 0 322.9 0 208S93.1 0 208 0S416 93.1 416 208zM208 352a144 144 0 1 0 0-288 144 144 0 1 0 0 288z"/></svg>';
  const CODE_ICON =
    /* solid code */ '<svg class="d-icon svg-icon" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"><path d="M392.8 1.2c-17-4.9-34.7 5-39.6 22l-128 448c-4.9 17 5 34.7 22 39.6s34.7-5 39.6-22l128-448c4.9-17-5-34.7-22-39.6zm80.6 120.1c-12.5 12.5-12.5 32.8 0 45.3L562.7 256l-89.4 89.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l112-112c12.5-12.5 12.5-32.8 0-45.3l-112-112c-12.5-12.5-32.8-12.5-45.3 0zm-306.7 0c-12.5-12.5-32.8-12.5-45.3 0l-112 112c-12.5 12.5-12.5 32.8 0 45.3l112 112c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L77.3 256l89.4-89.4c12.5-12.5 12.5-32.8 0-45.3z"/></svg>';
  const CLOSE_ICON =
    /* solid xmark */ '<svg class="d-icon svg-icon" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><path d="M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z"/></svg>';
  const SETTINGS_ICON =
    /* solid gear */ '<svg class="d-icon svg-icon" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M495.9 166.6c3.2 8.7 .5 18.4-6.4 24.6l-43.3 39.4c1.1 8.3 1.7 16.8 1.7 25.4s-.6 17.1-1.7 25.4l43.3 39.4c6.9 6.2 9.6 15.9 6.4 24.6c-4.4 11.9-9.7 23.3-15.8 34.3l-4.7 8.1c-6.6 11-14 21.4-22.1 31.2c-5.9 7.2-15.7 9.6-24.5 6.8l-55.7-17.7c-13.4 10.3-28.2 18.9-44 25.4l-12.5 57.1c-2 9.1-9 16.3-18.2 17.8c-13.8 2.3-28 3.5-42.5 3.5s-28.7-1.2-42.5-3.5c-9.2-1.5-16.2-8.7-18.2-17.8l-12.5-57.1c-15.8-6.5-30.6-15.1-44-25.4L83.1 425.9c-8.8 2.8-18.6 .3-24.5-6.8c-8.1-9.8-15.5-20.2-22.1-31.2l-4.7-8.1c-6.1-11-11.4-22.4-15.8-34.3c-3.2-8.7-.5-18.4 6.4-24.6l43.3-39.4C64.6 273.1 64 264.6 64 256s.6-17.1 1.7-25.4L22.4 191.2c-6.9-6.2-9.6-15.9-6.4-24.6c4.4-11.9 9.7-23.3 15.8-34.3l4.7-8.1c6.6-11 14-21.4 22.1-31.2c5.9-7.2 15.7-9.6 24.5-6.8l55.7 17.7c13.4-10.3 28.2-18.9 44-25.4l12.5-57.1c2-9.1 9-16.3 18.2-17.8C227.3 1.2 241.5 0 256 0s28.7 1.2 42.5 3.5c9.2 1.5 16.2 8.7 18.2 17.8l12.5 57.1c15.8 6.5 30.6 15.1 44 25.4l55.7-17.7c8.8-2.8 18.6-.3 24.5 6.8c8.1 9.8 15.5 20.2 22.1 31.2l4.7 8.1c6.1 11 11.4 22.4 15.8 34.3zM256 336a80 80 0 1 0 0-160 80 80 0 1 0 0 160z"/></svg>';
  ...
  const RELOAD_ICON =
    /* solid rotate-right */ '<svg class="d-icon svg-icon" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M463.5 224H472c13.3 0 24-10.7 24-24V72c0-9.7-5.8-18.5-14.8-22.2s-19.3-1.7-26.2 5.2L413.4 96.6c-87.6-86.5-228.7-86.2-315.8 1c-87.5 87.5-87.5 229.3 0 316.8s229.3 87.5 316.8 0c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0c-62.5 62.5-163.8 62.5-226.3 0s-62.5-163.8 0-226.3c62.2-62.2 162.7-62.5 225.3-1L327 183c-6.9 6.9-8.9 17.2-5.2 26.2s12.5 14.8 22.2 14.8H463.5z"/></svg>';
  const DOWNLOAD_ICON =
    /* solid download */ '<svg class="d-icon svg-icon" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M288 32c0-17.7-14.3-32-32-32s-32 14.3-32 32V274.7l-73.4-73.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l128 128c12.5 12.5 32.8 12.5 45.3 0l128-128c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L288 274.7V32zM64 352c-35.3 0-64 28.7-64 64v32c0 35.3 28.7 64 64 64H448c35.3 0 64-28.7 64-64V416c0-35.3-28.7-64-64-64H346.5l-45.3 45.3c-25 25-65.5 25-90.5 0L165.5 352H64zm368 56a24 24 0 1 1 0 48 24 24 0 1 1 0-48z"/></svg>';
  const COPY_ICON =
  ...
  const UPLOAD_ICON =
    /* solid upload */ '<svg class="d-icon svg-icon" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M288 109.3V352c0 17.7-14.3 32-32 32s-32-14.3-32-32V109.3l-73.4 73.4c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3l128-128c12.5-12.5 32.8-12.5 45.3 0l128 128c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L288 109.3zM64 352H192c0 35.3 28.7 64 64 64s64-28.7 64-64H448c35.3 0 64 28.7 64 64v32c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V416c0-35.3 28.7-64 64-64zM432 456a24 24 0 1 0 0-48 24 24 0 1 0 0 48z"/></svg>';
  const PASTE_ICON =
  ...
  const DELETE_ICON =
    /* regular trash-can */ '<svg class="d-icon svg-icon" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M170.5 51.6L151.5 80h145l-19-28.4c-1.5-2.2-4-3.6-6.7-3.6H177.1c-2.7 0-5.2 1.3-6.7 3.6zm147-26.6L354.2 80H368h48 8c13.3 0 24 10.7 24 24s-10.7 24-24 24h-8V432c0 44.2-35.8 80-80 80H112c-44.2 0-80-35.8-80-80V128H24c-13.3 0-24-10.7-24-24S10.7 80 24 80h8H80 93.8l36.7-55.1C140.9 9.4 158.4 0 177.1 0h93.7c18.7 0 36.2 9.4 46.6 24.9zM80 128V432c0 17.7 14.3 32 32 32H336c17.7 0 32-14.3 32-32V128H80zm80 64V400c0 8.8-7.2 16-16 16s-16-7.2-16-16V192c0-8.8 7.2-16 16-16s16 7.2 16 16zm80 0V400c0 8.8-7.2 16-16 16s-16-7.2-16-16V192c0-8.8 7.2-16 16-16s16 7.2 16 16zm80 0V400c0 8.8-7.2 16-16 16s-16-7.2-16-16V192c0-8.8 7.2-16 16-16s16 7.2 16 16z"/></svg>';
  ...
  if (window.shuiyuanHelperLoaded) {
    ...
    console.log(
      "Skipped loading Shuiyuan Helper as it has already been loaded."
    );
    return;
  }
  ...
  const getDataPreloaded = () => {
    ...
    dataPreloaded = JSON.parse(
      document.getElementById("data-preloaded").getAttribute("data-preloaded")
    );
    return dataPreloaded;
  };
  ...
  const getEmojiInfo = () => {
    ...
    try {
      const statements = window
        ...
        .getComponentTemplate(
          window.require("discourse/components/emoji-group-sections").default
        )().parsedLayout.block[0];
      ...
      // eslint-disable-next-line no-console
      console.warn(
        "Could not parse all standard emojis from source, falling back to built-in emojis."
      );
      // cSpell: disable
    ...
    try {
      ...
      // eslint-disable-next-line no-console
      console.warn(
        "Could not parse custom emojis from source, falling back to built-in emojis."
      );
      // cSpell: disable
    ...
    emojiInfo.customEmojisMap = new Map(
      emojiInfo.customEmojis.map((ce) => [ce.name, ce.url])
    );
  ...
  const loadIgnoredUsers = () => {
    if (!shuiyuanHelperMemory.has("ignoredUsersLowerCaseSet")) {
      ...
      shuiyuanHelperMemory.set(
        "hideRetortsOfIgnoredUsers",
        Boolean(currentUser.custom_fields?.hide_ignored_retorts)
      );
    }
  };
  ...
  const parseBirthdayMonthDate = (birthdayString) => {
    ...
    const [month, date] = birthdayString
      .split("-")
      .map((s) => parseInt(s, 10))
      .slice(1);
  ...
  const getPreferencesRoute = () =>
    `/u/${encodeURIComponent(getCurrentUsername())}/preferences/account`;
  const getShuiyuanHelperRoute = () =>
    `/u/${encodeURIComponent(
      getCurrentUsername()
    )}/preferences/interface${SETTINGS_VIEW_FRAGMENT}`;
  ...
  const isElementHandledByFeature = (element, feature) =>
    element.shuiyuanHelperHandledFeatures?.has(feature) ?? false;
  ...
  const getDataAtElement = (element, key) =>
    element.shuiyuanHelperData?.get(key);

  const hasDataAtElement = (element, key) =>
    element.shuiyuanHelperData?.has(key) ?? false;

  const deleteDataAtElement = (element, key) =>
    element.shuiyuanHelperData?.delete(key);

  // Look for a retort button with the given postId and emoji in the page.
  const findRetortButton = (postId, emoji) =>
  ...
  const findUsernameInUserPage = (userMain) => {
    const usernameNode = userMain.querySelector(
  ...
  const getPostCookedDiv = (postOrPostId) => {
    ...
    if (Number.isInteger(postOrPostId)) {
      return document.querySelector(
        `article[data-post-id="${postOrPostId}"] .cooked:not(.embedded-posts .cooked)`
      );
    }
  ...
  const discourseFetch = async (url, fetchOptions, customOptions) => {
    ...
    while (true) {
      ...
      if (response.status === 429) {
        ...
        // eslint-disable-next-line no-await-in-loop
        await sleep(
          1000 * EXP_BACKOFF_START * EXP_BACKOFF_BASE ** (currentAttempt - 1)
        );
        continue;
      }
      if (expectOkStatus && !response.ok) {
        throw new Error(
          `discourseFetch: ${response.status}${
  ...
  const getUserInfo = async (username) => {
    const result = await (
      await discourseFetch(`/u/${encodeURIComponent(username)}.json`)
    ).json();
    return result?.user?.username?.toLowerCase() === username.toLowerCase()
      ? result.user
      : null;
  };
  ...
  const getUserInfoFromTL0Group = async (username) => {
    ...
    while (true) {
      ...
      const res = await discourseFetch(
        `/groups/trust_level_0/members.json?order=added_at&asc=true&filter=${encodeURIComponent(
          username
        )}&limit=${FETCH_ITEMS_PER_PAGE}&offset=${offset}`
      );
      // eslint-disable-next-line no-await-in-loop
      ...
      if (matchingMembers.length > 1) {
        throw new Error(
          `unexpected multiple members with username ${username} found`
        );
      }
      if (matchingMembers.length === 1) {
  ...
  const getUserByIdFromTL0Group = async (id) => {
    ...
    const getMaxIdAndOffset = async () => {
      const data = await (
        await discourseFetch(
          "/groups/trust_level_0/members.json?order=added_at&limit=1&offset=0"
        )
      ).json();
    ...
    const fetchTL0Members = async (offset, limit) => {
      ...
      const res = await discourseFetch(
        `/groups/trust_level_0/members.json?order=added_at&asc=true&limit=${
          limit ?? FETCH_ITEMS_PER_PAGE
        }&offset=${queryOffset}`
      );
      const members = (await res.json()).members;
    ...
    const guessIdOffset = (
      ...
      const guessedTargetOffset = Math.round(
        leftOffset + (targetId - leftId) / slope
      );
      if (
        guessedTargetOffset < leftOffset ||
        guessedTargetOffset > rightOffset
      ) {
    ...
    // eslint-disable-next-line no-constant-condition
    while (true) {
      const guessedOffset = guessIdOffset(
        leftId,
        leftOffset,
        rightId,
        rightOffset,
      ...
      const queryOffset = Math.max(
        Math.round(guessedOffset - FETCH_ITEMS_PER_PAGE / 2),
        leftOffset
      );
      // eslint-disable-next-line no-await-in-loop
      ...
      if (members.length === 0) {
        throw new Error(
          `no members found in interval, queryOffset = ${queryOffset}`
        );
      }
      ...
      if (newWidth >= width) {
        throw new Error(
          "interval width not decreasing, infinite loop detected"
        );
      }
      if (newWidth < 0) {
  ...
  const getOnlineUserCount = async () => {
    ...
    while (true) {
      // eslint-disable-next-line no-await-in-loop
      const res = await discourseFetch(
        `/groups/trust_level_0/members.json?order=last_seen_at&limit=1000&offset=${offset}`
      ); // 1000 is the max page size
      // eslint-disable-next-line no-await-in-loop
      const members = (await res.json())?.members || [];
      if (!members.length) {
        break;
    ...
    const res = await discourseFetch(
      "/polls/vote",
      {
        ...
        body: [
          ...
          ...submitOptions.map(
            (option) => `options%5B%5D=${encodeURIComponent(option)}`
          ),
        ].join("&"),
      },
  ...
  for (const group of ALL_FEATURE_GROUPS) {
    ...
    if (typeof group.description !== "string" || !group.description) {
      throw new Error(
        `Missing or invalid description for feature group ${group.id}`
      );
    }
    const unrecognizedFields = setDifference(
      new Set(Object.keys(group)),
      FEATURE_GROUP_FIELDS_SET
    );
  ...
  const allFeatureGroupDescriptions = new Set(
    ALL_FEATURE_GROUPS.map((g) => g.description)
  );
  ...
  const ALL_FEATURES = [
    {
      ...
      onInitialize: () => {
        ...
        const QQ_EMOJIS_LIST = [
          {
            name: "微笑",
            url: "/uploads/default/original/3X/0/2/02512d1973582ba0ad99c63c1c862f4e2cb95813.png",
            shortUrl: "upload://kuSbYfw4Um2efSqNicK2pm5f11.png",
          },
          {
            name: "撇嘴",
            url: "/uploads/default/original/3X/7/3/732ba1ceb18a931509781ef8464c45be74057770.png",
            shortUrl: "upload://gqQocxz9CD0CFMoyYMKuHAERbSo.png",
          },
          {
            name: "色",
            url: "/uploads/default/original/3X/0/6/06851ce4cce04713b9a315e27e00c63b173ab8d3.png",
            shortUrl: "upload://VG3AgTZubatjpJBHMuah9IB7Jp.png",
          },
          {
            name: "发呆",
            url: "/uploads/default/original/3X/5/e/5e1a5a33a7372b932bd8e3be52ce21d4abe2cc81.png",
            shortUrl: "upload://dqtlc9W7diM4NOw1pq3CIUBek1j.png",
          },
          {
            name: "得意",
            url: "/uploads/default/original/3X/b/c/bc848fd77ae9ff0171a562bc7c8212396e481bb2.png",
            shortUrl: "upload://qTHMaEMQcZVGZyelhKkJub8RhZM.png",
          },
          {
            name: "流泪",
            url: "/uploads/default/original/3X/c/6/c6e29fa837cd17eefa72346419a668dfc415f13e.png",
            shortUrl: "upload://snq4QdYMA5n03l30YhZW5wHhqa2.png",
          },
          {
            name: "害羞",
            url: "/uploads/default/original/3X/2/9/29e3c91f3f68ace01664d688f89e45dc290942ff.png",
            shortUrl: "upload://5YzBuGoFZSuAEgcDwhGjP47fhNB.png",
          },
          {
            name: "闭嘴",
            url: "/uploads/default/original/3X/7/3/7354da7ee6bafa8b22fb28bb6fbd36a64b99f667.png",
            shortUrl: "upload://gsgHPgmYENqgwjyca665jma4Ew7.png",
          },
          {
            name: "睡",
            url: "/uploads/default/original/3X/d/6/d631e2c3e8c64587cca05f800c4bd30ec4854066.png",
            shortUrl: "upload://uyR3CVqMux73geQPGL0b5xPL9ki.png",
          },
          {
            name: "大哭",
            url: "/uploads/default/original/3X/9/e/9ef51e66101dd332fce94be5cab4afc5e7c9958a.png",
            shortUrl: "upload://mGcBuVucsKQ7rXRB7fsWTJcHkvM.png",
          },
          {
            name: "尴尬",
            url: "/uploads/default/original/3X/5/e/5e73f45df1206341c3c0934386d375a3540607fb.png",
            shortUrl: "upload://dtzjrVLj8baHp9IqbyCUYnClKH1.png",
          },
          {
            name: "发怒",
            url: "/uploads/default/original/3X/d/a/da329451d1d5526e8bfcdc81251e2b06ddb8883a.png",
            shortUrl: "upload://v8gsaA5kooXgLbRkAXabeSrgVg6.png",
          },
          {
            name: "调皮",
            url: "/uploads/default/original/3X/1/7/17ecf38c5d27a2c95171e7639adc4aae486cbc94.png",
            shortUrl: "upload://3pEEa1tvhXNDzQycaoAu02w7ozO.png",
          },
          {
            name: "呲牙",
            url: "/uploads/default/original/3X/7/6/76d6fc5a95aede60b4927647adecf779e851ae79.png",
            shortUrl: "upload://gXiWFRjg4dXh5cHi5ksEUPrNXnP.png",
          },
          {
            name: "惊讶",
            url: "/uploads/default/original/3X/c/f/cf96a1fbef4a91ab54b37ff7a1daa8b7689831eb.png",
            shortUrl: "upload://tCpz41mnTZVTQLVbPC5rynsTxOz.png",
          },
          {
            name: "难过",
            url: "/uploads/default/original/3X/a/4/a4a010653794ca56135a5a5c41e3c07c9081d157.png",
            shortUrl: "upload://nuleVAlIObShNCWzq7k7OrNzhuT.png",
          },
          {
            name: "酷",
            url: "/uploads/default/original/3X/5/b/5ba6a30a11901bd8f8cd6dcbfac5e773b073e564.png",
            shortUrl: "upload://d4MsZHhwwEUqCqoD9pLJLQ5HVUU.png",
          },
          {
            name: "冷汗",
            url: "/uploads/default/original/3X/d/3/d32c312b0fb47d2efe045602237037d9f5ad9147.png",
            shortUrl: "upload://u87quDd6wvuzMzdm9mslE0EWVtJ.png",
          },
          {
            name: "抓狂",
            url: "/uploads/default/original/3X/f/3/f366866d4e0f1172b9260758fa6b208496a73b39.png",
            shortUrl: "upload://yJdGqCpihZRkRl7SKdDHt95PPgR.png",
          },
          {
            name: "吐",
            url: "/uploads/default/original/3X/4/4/4471302a428dccf005433bf2739e599d0fd71e3c.png",
            shortUrl: "upload://9LsYibplGbJpJINTpAOiZe2niBm.png",
          },
          {
            name: "偷笑",
            url: "/uploads/default/original/3X/d/5/d51bb295ddbbdc5dbc07322781a04502e54504cb.png",
            shortUrl: "upload://upf2Frg5ltwgPTmOezNKNLZ36vp.png",
          },
          {
            name: "可爱",
            url: "/uploads/default/original/3X/1/8/18de88740005ec99452b8b7e4af65db2cc8533fb.png",
            shortUrl: "upload://3y0evPyKwAlldy986v2O4fUhGC7.png",
          },
          {
            name: "白眼",
            url: "/uploads/default/original/3X/1/a/1a28fdc062b459d8667934cf2bd877854bf63d53.png",
            shortUrl: "upload://3JqeIYY159N6vCm8oJNeQzZ14Vd.png",
          },
          {
            name: "傲慢",
            url: "/uploads/default/original/3X/4/0/400070f9fd468c002f17f73a6f3ca1235be0f9cd.png",
            shortUrl: "upload://98bvdUVI06GYQluQ7ief0OEXQJL.png",
          },
          {
            name: "饥饿",
            url: "/uploads/default/original/3X/2/d/2d2ab711c283b423f4d329f8ee0c445d462d085e.png",
            shortUrl: "upload://6rz0b4JDpY91WDdGMhq4LeTKUeq.png",
          },
          {
            name: "困",
            url: "/uploads/default/original/3X/1/3/13ea015ca511b283567932873d7d97db557a61d7.png",
            shortUrl: "upload://2QaqpDuBDkWW7Ii3e22x0v3eU6z.png",
          },
          {
            name: "惊恐",
            url: "/uploads/default/original/3X/7/e/7ec419e533f1e20a96ba64d2750222e2c924151b.png",
            shortUrl: "upload://i5qiYuMNfaF3v0EFdLki6p2XdtV.png",
          },
          {
            name: "流汗",
            url: "/uploads/default/original/3X/d/0/d0b4f96da4d4f00d52e675478bab84d59a8043fb.png",
            shortUrl: "upload://tMj34wT2IbZ2Lq3OofjRDc6VBNN.png",
          },
          {
            name: "憨笑",
            url: "/uploads/default/original/3X/d/3/d31a65ec7b07ed8d99b3ac5f7a29c4fbd4697330.png",
            shortUrl: "upload://u7viQE1XvXMk9nl6jWSUiU1QWGI.png",
          },
          {
            name: "悠闲",
            url: "/uploads/default/original/3X/1/6/1683e08b156757c24ce5a055ea2cbf95c533f0a3.png",
            shortUrl: "upload://3db35mfRKXbm7cpDwXdELrTB6Vl.png",
          },
          {
            name: "奋斗",
            url: "/uploads/default/original/3X/c/f/cf562b71d84f95d53f0c82c8e50ac8911ce9f324.png",
            shortUrl: "upload://tAbs9F1N5qxRjups44RqujxhhpG.png",
          },
          {
            name: "咒骂",
            url: "/uploads/default/original/3X/9/6/96f72f0fe84e8521ed6aedae17909e96e2adce1d.png",
            shortUrl: "upload://lxvcZiqefTwATmGsDZ96mMV6vw1.png",
          },
          {
            name: "疑问",
            url: "/uploads/default/original/3X/5/1/51a8d68121439088df5bd00c8b2d5b3b8cc61d74.png",
            shortUrl: "upload://bEopkS5Dplh90EtD8r5wbIhFgpu.png",
          },
          {
            name: "嘘",
            url: "/uploads/default/original/3X/2/5/2519434fa2db53372cff039fb7c74544e4adf57e.png",
            shortUrl: "upload://5ibN6q4OEHcVyXI5qW0LEpX58ei.png",
          },
          {
            name: "晕",
            url: "/uploads/default/original/3X/c/e/cef182bf010258fa7da18b7ae5ef303de035ff48.png",
            shortUrl: "upload://twHNbhL2wMHONpAAIwz15yvbpnW.png",
          },
          {
            name: "折磨",
            url: "/uploads/default/original/3X/d/a/dade2f84e79775548f3caef485c35774210731b8.png",
            shortUrl: "upload://vec7nEC2xZFu9NTQnDCHFLjnysg.png",
          },
          {
            name: "衰",
            url: "/uploads/default/original/3X/4/2/422f9ac4196102e70d6493542898a313cfbd9153.png",
            shortUrl: "upload://9rvvkw8KzrF1EUqkBbRW3vt4ne3.png",
          },
          {
            name: "骷髅",
            url: "/uploads/default/original/3X/0/c/0cc75ae9965cdc8953dad63aea1ded7485d00ee0.png",
            shortUrl: "upload://1P2Qs9JZYIUxoxhFSdo10wyNL0c.png",
          },
          {
            name: "敲打",
            url: "/uploads/default/original/3X/4/5/45ba7c6c2df2fdc2ed8fce1ae74478f74fc9fd1d.png",
            shortUrl: "upload://9WQunhDNkrJ0w1OrvRnlok4qudf.png",
          },
          {
            name: "再见",
            url: "/uploads/default/original/3X/b/9/b9c3d72781a59c8240db2f3df687c49b18223179.png",
            shortUrl: "upload://qvlUVLOAdaGXbc2Bkdn9UPXsP33.png",
          },
          {
            name: "擦汗",
            url: "/uploads/default/original/3X/9/a/9a52922e790c3063a6fd5365745a1955f9f9123d.png",
            shortUrl: "upload://m1cr9QSTYHO8axMcBuo90FwHs7j.png",
          },
          {
            name: "抠鼻",
            url: "/uploads/default/original/3X/3/2/320d5099ea174a8aed53aae170e1caae59175fdb.png",
            shortUrl: "upload://78MoPlnoyiNH9TT5NCJ0A9O26fN.png",
          },
          {
            name: "鼓掌",
            url: "/uploads/default/original/3X/5/c/5c2ed6f4ae928294c7b685b05ae77c517ec13e0e.png",
            shortUrl: "upload://d9uhprLKUG2ylbXAIq5wdsa4w1g.png",
          },
          {
            name: "糗大了",
            url: "/uploads/default/original/3X/e/d/ed2b594e1e01f4c1ae1b74597cb887fa6b14d284.png",
            shortUrl: "upload://xQ62arCsoiU7BfYw83jfRkDfT5W.png",
          },
          {
            name: "坏笑",
            url: "/uploads/default/original/3X/b/2/b25ba81c6d7e5648806b36992974258e8997fd46.png",
            shortUrl: "upload://prPmwrCeYBQHJUt8juM3uIE6kOa.png",
          },
          {
            name: "左哼哼",
            url: "/uploads/default/original/3X/a/a/aaf08245b8966973d868180817759636abd70ca6.png",
            shortUrl: "upload://oocso2DmuZzApw7gbD6CLuzX2hE.png",
          },
          {
            name: "右哼哼",
            url: "/uploads/default/original/3X/0/2/020222249dc19558da171f7fa2c2cc0331d68727.png",
            shortUrl: "upload://hLwAFjU7Q6m2Sckp03943gp7fh.png",
          },
          {
            name: "哈欠",
            url: "/uploads/default/original/3X/7/4/74e995efac57f33a730ac2ea2d2845d10a0b3b1b.png",
            shortUrl: "upload://gGfQb7apjt9LqMND47NUAIxXmkP.png",
          },
          {
            name: "鄙视",
            url: "/uploads/default/original/3X/f/a/fa75a98f28095ba2049a4be5086223b29f97c575.png",
            shortUrl: "upload://zJFsoBFAUJmRiW1qNrWXq9N1ilL.png",
          },
          {
            name: "委屈",
            url: "/uploads/default/original/3X/7/0/700a6333db814b5c1e4618a0fb069abfbfd9e8f6.png",
            shortUrl: "upload://fZ9Jn94Ua6y0182gceFiIE21gLY.png",
          },
          {
            name: "快哭了",
            url: "/uploads/default/original/3X/f/7/f7fd7a507d7b556afc71dd40c914b65fbf6fdc05.png",
            shortUrl: "upload://znP0y4g4jSNviFKyp79ALJpE7Ln.png",
          },
          {
            name: "阴险",
            url: "/uploads/default/original/3X/2/2/2270d03bac9233cd51dd1e9b8aa01c09ba2dc8dc.png",
            shortUrl: "upload://4UFW0uH6y5JkD2argEOUKIbdt8M.png",
          },
          {
            name: "右亲亲",
            url: "/uploads/default/original/3X/c/d/cdf8dda07b050b4b7536131f14ce65ea4c380c5a.png",
            shortUrl: "upload://to74zIRYhCn1r9W5Aqjf88UqhN8.png",
          },
          {
            name: "左亲亲",
            url: "/uploads/default/original/3X/d/e/de4ae2b472b0dd3a719284dafa7e81d82e5f4925.png",
            shortUrl: "upload://vIurhsd7wBhRi8epRIyUkI67kWx.png",
          },
          {
            name: "吓",
            url: "/uploads/default/original/3X/6/0/60cdbeee2be4a957329aaea3bf7b5ddc4431dd16.png",
            shortUrl: "upload://dOmE1vnZ5fy2B3hrYgblmdpLBNI.png",
          },
          {
            name: "可怜",
            url: "/uploads/default/original/3X/e/d/ed67e3492bedb1d288dda5e365dad8f9e051886e.png",
            shortUrl: "upload://xSbJPjNqePU99KlWicM1wARNmX4.png",
          },
          {
            name: "眨眼睛",
            url: "/uploads/default/original/3X/e/f/efb08424d314842b3200ff63f051c55da8d55298.png",
            shortUrl: "upload://ycoizKGLLWNH1oelxHmnQYbDEuY.png",
          },
          {
            name: "笑哭",
            url: "/uploads/default/original/3X/9/7/97025a0a6abcb8afe76c9b1953a9a5c93fb16cc8.png",
            shortUrl: "upload://lxT8t0j6FdTp60YCjBlzjpChC9a.png",
          },
          {
            name: "doge",
            url: "/uploads/default/original/2X/c/cd650448509fa9043afbb435787db26266069e02.png",
            shortUrl: "upload://tj0j8Y0KlePMXBMPq1x6hOEy9Ts.png",
          },
          {
            name: "泪奔",
            url: "/uploads/default/original/3X/b/a/ba835c4a29fed666638387649764f416835322f6.png",
            shortUrl: "upload://qBYfnF2GxjgbsBOWBmSvYq5BZrg.png",
          },
          {
            name: "无奈",
            url: "/uploads/default/original/3X/0/a/0af813ab362e666fbd89800e9f0317753ac05208.png",
            shortUrl: "upload://1z2hagtCyzbxLhTdZfVji7rbkWQ.png",
          },
          {
            name: "托腮",
            url: "/uploads/default/original/3X/2/e/2e520b69cc9697ae707e9bc03be14c9e443cde23.png",
            shortUrl: "upload://6BLK5qWZoZJXfIGWksXaL4x3sTF.png",
          },
          {
            name: "卖萌",
            url: "/uploads/default/original/3X/2/1/21282fdb772c91cb76fedf55f38378685667a82d.png",
            shortUrl: "upload://4JjR6YbcvXT6ffl3CAnbkinR30p.png",
          },
          {
            name: "斜眼笑",
            url: "/uploads/default/original/3X/1/5/15b6a8845beefee8f959753f8c1aea696e290d21.png",
            shortUrl: "upload://365mXSO8shJEMcbVjsg7YhoXpMl.png",
          },
          {
            name: "喷血",
            url: "/uploads/default/original/3X/a/8/a8dc8d07ed5f18210a6a80b92b61df7492439e47.png",
            shortUrl: "upload://o5OK4IPaOR8VwDsmbuRWItPEreD.png",
          },
          {
            name: "惊喜",
            url: "/uploads/default/original/3X/5/3/53cd95b25b440d0120e95c9e36d1abff6d29064c.png",
            shortUrl: "upload://bXm5MPB3rzWPqL1EFb8Tda0oAVK.png",
          },
          {
            name: "骚扰",
            url: "/uploads/default/original/3X/8/1/81f29ce737af495b07b3f2b29b125710cbc2c1cb.png",
            shortUrl: "upload://ixzo8ZotxFPrbAXGaz4Ddpu22lZ.png",
          },
          {
            name: "小纠结",
            url: "/uploads/default/original/3X/9/8/98da4e42b2d352c34870db3d105e02b13bb37b3f.png",
            shortUrl: "upload://lOcibxtqck7fZcT4MbamIkgotVZ.png",
          },
          {
            name: "我最美",
            url: "/uploads/default/original/3X/9/4/94d1c55617046cb931f78458acc032b563e88220.png",
            shortUrl: "upload://lew6389FQpyZBNeiyuZyB3jfx04.png",
          },
          {
            name: "加油必胜",
            url: "/uploads/default/original/3X/f/d/fd83efe907d0263ff742bc37d3b8142f77203c6e.png",
            shortUrl: "upload://AaHtoiqGXAB3Lh4D7uStyGH4T5c.png",
          },
          {
            name: "加油抱抱",
            url: "/uploads/default/original/3X/3/8/38ac8d3fd8b42291b1e607e8f8b8e24df9daef04.png",
            shortUrl: "upload://85mqAdnUnRpghrQRriepkJ14OuE.png",
          },
          {
            name: "口罩护体",
            url: "/uploads/default/original/3X/d/6/d6f4232b9e262d6f988258e67e9c4e8302f0c92d.png",
            shortUrl: "upload://uFzeUU0N4rbpcRAoy7Uh51xrKUd.png",
          },
          {
            name: "搬砖中",
            url: "/uploads/default/original/3X/1/4/143f089fb3bee7d607ecde61cfa51a9a254970e8.png",
            shortUrl: "upload://2T6B6tPBTw4mvy9NyTCxjZ8rW2Y.png",
          },
          {
            name: "忙到飞起",
            url: "/uploads/default/original/3X/4/5/457783618e40210ff0e46a48475190c32225980e.png",
            shortUrl: "upload://9Ux056cSaWzzqApB7oETYsCYb9Q.png",
          },
          {
            name: "脑阔疼",
            url: "/uploads/default/original/3X/2/6/2676bdca2cb5b11b1fbe9689e6e992ddbff1f843.png",
            shortUrl: "upload://5ugxR8lV6D1FCNTrPPnGXrDQpjl.png",
          },
          {
            name: "沧桑",
            url: "/uploads/default/original/3X/e/5/e5d9e324813422c38cd74299b980548310eec4d0.png",
            shortUrl: "upload://wNma2Zoix0gZRuSCbpi4Jo44s8g.png",
          },
          {
            name: "捂脸",
            url: "/uploads/default/original/3X/d/c/dc822dc0974ab503842ecd76aee38be92552cbfd.png",
            shortUrl: "upload://vsHWUgcf6vyLiLlml4cJXQrsZ65.png",
          },
          {
            name: "辣眼睛",
            url: "/uploads/default/original/3X/f/e/fea1a4d76d2263d2b2b0afc1b47aa477f1d93837.png",
            shortUrl: "upload://AkzB4D2X9gRROVUVYUsqxL9SZoP.png",
          },
          {
            name: "哦哟",
            url: "/uploads/default/original/3X/4/4/4430eb4cb61210380c414e1fb83a32ce5c1f1a2d.png",
            shortUrl: "upload://9Jfh9SnO1KiXp1QH0raLB3uxR4F.png",
          },
          {
            name: "头秃",
            url: "/uploads/default/original/3X/9/6/96d46c39c964abb5fc9e2c5d56ea2891501c73cb.png",
            shortUrl: "upload://lwiJwmjvOmAdG5ET9KO0QIMaBVV.png",
          },
          {
            name: "问号脸",
            url: "/uploads/default/original/3X/7/f/7f6e0b0f84b6e4a2e7412c2f6ac6c824c2ba5337.png",
            shortUrl: "upload://ibip7H4AHA7lMtr7sHWc7ZixdAj.png",
          },
          {
            name: "暗中观察",
            url: "/uploads/default/original/3X/4/c/4cb1939c802cc3a4d6bbc3b688b922e89c85a402.png",
            shortUrl: "upload://aWsK7tiY60tnfsaSgvB24CQVmca.png",
          },
          {
            name: "emm",
            url: "/uploads/default/original/3X/d/3/d3767f7da99b2c112a7894ef0aead34143223d97.png",
            shortUrl: "upload://uaGCSvpinFuTkAMrJmIKOEWFL8j.png",
          },
          {
            name: "吃瓜",
            url: "/uploads/default/original/3X/f/c/fc89ce11fec2351ba8ec6213b29efc7c662f84e5.png",
            shortUrl: "upload://A23zeDeaOAZah57sJdIgSAGMne5.png",
          },
          {
            name: "呵呵哒",
            url: "/uploads/default/original/3X/c/e/ce281ff16dd9efa18546190690e011720c2254ae.png",
            shortUrl: "upload://tpKkczHhdgFozytZwyA5X2UGtkO.png",
          },
          {
            name: "汪汪",
            url: "/uploads/default/original/3X/3/0/30bb3327fee2b57088ec3f6c3a4aac11ca043705.png",
            shortUrl: "upload://6X5ZwEuvgBeaCfqJrRZv2gUpUH3.png",
          },
          {
            name: "牛转钱坤",
            url: "/uploads/default/original/3X/f/b/fb097ee97427031b40bd7f68493ca33db034ae72.png",
            shortUrl: "upload://zOMbKWLVjTXoByME6fs6u7Eao14.png",
          },
          {
            name: "牛气冲天",
            url: "/uploads/default/original/3X/d/9/d9d487fcddda75b47064f0c4f8d51eb665a9ef0c.png",
            shortUrl: "upload://v50Xl2TliXvy7AfhgTUKzFeryR6.png",
          },
          {
            name: "无眼笑",
            url: "/uploads/default/original/3X/b/4/b4026c1d578e041b316725a44404846a03b17005.png",
            shortUrl: "upload://pGr8kX8RCc50nq7lUlJMjBjLggd.png",
          },
          {
            name: "敬礼",
            url: "/uploads/default/original/3X/a/f/af03264c8687e37482b8510333fb05371b87b726.png",
            shortUrl: "upload://oYeiVFS3ZSgo0mXHfqZ4YXdF0oK.png",
          },
          {
            name: "狂笑",
            url: "/uploads/default/original/3X/a/6/a60100a1b63b9884fc4feedab72d7e4432148785.png",
            shortUrl: "upload://nGxphR9zQrLVZ6SO6bm04lqVXP7.png",
          },
          {
            name: "面无表情",
            url: "/uploads/default/original/3X/6/f/6f73f350069bd3a5d1fb65ce8d62de83c7d38694.png",
            shortUrl: "upload://fTXq9KyCqaDFHLYbSwmo2AaF6O8.png",
          },
          {
            name: "摸鱼",
            url: "/uploads/default/original/3X/1/0/10b59d12dcdaadeb4cd66a98288d92e93e987f18.png",
            shortUrl: "upload://2nOKb1JSVayorYyYy7RGFDBTpYQ.png",
          },
          {
            name: "摸锦鲤",
            url: "/uploads/default/original/3X/0/b/0b12568fea427631e0c06a47903735537afc1805.png",
            shortUrl: "upload://1zWxzjqMXUwIYyVcBIjtp5BibB3.png",
          },
          {
            name: "魔鬼笑",
            url: "/uploads/default/original/3X/9/d/9da781c625c4fd2928acfd72e7aba4602e8a4db3.png",
            shortUrl: "upload://muFQnq31ZwR2k9k84gDABTZxsxt.png",
          },
          {
            name: "哦",
            url: "/uploads/default/original/3X/6/c/6c312dce5a3cddfe9e17bf4213ba9cb943f1c9d1.png",
            shortUrl: "upload://fr6VNiAbKLhZKI5X7isHPUw7kHf.png",
          },
          {
            name: "请",
            url: "/uploads/default/original/3X/8/0/806acc1e12e3865d4ce016b7b86a707c7fd11d41.png",
            shortUrl: "upload://ik1VyXE8H5Tu6TFfEW4ONhFg5Jn.png",
          },
          {
            name: "睁眼",
            url: "/uploads/default/original/3X/9/f/9fe082ac5989af315f06095989049df6f6d50aec.png",
            shortUrl: "upload://mOkVBRK5mzO9LZ36kYxHehshz1a.png",
          },
          {
            name: "期待",
            url: "/uploads/default/original/3X/0/f/0fad175c80b5cd5eb1a445b1439eb25fba273531.png",
            shortUrl: "upload://2eG0w8B8clgFjxMNrbvOjx7D8xX.png",
          },
          {
            name: "拜谢",
            url: "/uploads/default/original/3X/1/c/1c836ff23328d80a7da6d69e4b36e1cfa8bf66af.png",
            shortUrl: "upload://44eYhojrMPPJ0d6uSoGaMiA9vD9.png",
          },
          {
            name: "元宝",
            url: "/uploads/default/original/3X/8/8/8810ee0460d7ab7f2092bd510e43f3f7e1522d2f.png",
            shortUrl: "upload://jpHcSPvIezXLktlWZ3sVfXvhhM3.png",
          },
          {
            name: "牛啊",
            url: "/uploads/default/original/3X/f/9/f9e61c1efb194d591fa03cef9f22bc6748909ed9.png",
            shortUrl: "upload://zEHTGKdWioRTfNjSFibi3bFcgcx.png",
          },
          {
            name: "胖三斤",
            url: "/uploads/default/original/3X/8/8/88179b7ef7537be258bac81734f7c5605625abf1.png",
            shortUrl: "upload://jpVvUbfEFLO00WvkHiknhVSINiN.png",
          },
          {
            name: "好闪",
            url: "/uploads/default/original/3X/f/9/f9f1649284e07a105e9e164a3323d20c86079dbc.png",
            shortUrl: "upload://zF64sCeNJuK6hXoehD2Kfskh5Uw.png",
          },
          {
            name: "打call",
            url: "/uploads/default/original/3X/7/2/72badcc43a8968e3d19763d7a018f9335355f65c.png",
            shortUrl: "upload://gmWMvApjCauHWHVWtm6DBZDCXkU.png",
          },
          {
            name: "变形",
            url: "/uploads/default/original/3X/1/f/1fb45aa46d9ae6abccd01f01cb8af7c301f3c84f.png",
            shortUrl: "upload://4wtcV5xUttwO6UofB3FMucGKqE7.png",
          },
          {
            name: "仔细分析",
            url: "/uploads/default/original/3X/3/9/39f8e297aac767767b3ce385ac0b4ee59da5c9f6.png",
            shortUrl: "upload://8gQrSNJBrgXzyQ0eYLjRwxAQJtY.png",
          },
          {
            name: "加油",
            url: "/uploads/default/original/3X/3/d/3d1850621234c49431af2773aaa31fab0519332f.png",
            shortUrl: "upload://8ItdwJRHs86Kq8YhuUakI9bhBYb.png",
          },
          {
            name: "菜汪",
            url: "/uploads/default/original/3X/3/9/39822224d1f9fd020c58cd371375c12d73f9c1ba.png",
            shortUrl: "upload://8cK1zbWwDCHBQUpbvqA0PFJ9aqu.png",
          },
          {
            name: "崇拜",
            url: "/uploads/default/original/3X/e/2/e242d6f65c0e19661d6e576314a71d96d7adfd64.png",
            shortUrl: "upload://whB6VpST8o37Tf3wQZtNNPrhQxe.png",
          },
          {
            name: "比心",
            url: "/uploads/default/original/3X/d/e/de6eb6665715ad02214adc2958b3950aa393c69d.png",
            shortUrl: "upload://vJJcktudVPFvHE7MG4wgyKKI0Xj.png",
          },
          {
            name: "庆祝",
            url: "/uploads/default/original/3X/1/a/1a619e13c7d1cd29f65487c6600e08a62af43d00.png",
            shortUrl: "upload://3LnyDMUlrqU6qeaca6UJ8WMsX2U.png",
          },
          {
            name: "吃糖",
            url: "/uploads/default/original/3X/4/2/4290980b2c3bc797fd09575970e698ec84d6b227.png",
            shortUrl: "upload://9uRiQWtKJ7zZ8Cq48sWDJOYiTeT.png",
          },
          {
            name: "花朵脸",
            url: "/uploads/default/original/3X/0/5/05c53eaaac5918c0f0e3b4d49afe38c0398a81bc.png",
            shortUrl: "upload://P2YUebyFSRxo1o72lBve5ZgXWk.png",
          },
          {
            name: "我想开了",
            url: "/uploads/default/original/3X/5/4/54d8d4269f0c18eee1f50a2472f9ac61e4f8b06a.png",
            shortUrl: "upload://c6AEYtW37PlUYATOgdXi5DhCZ98.png",
          },
          {
            name: "舔屏",
            url: "/uploads/default/original/3X/b/2/b25008f85d3e4a94953285407f90819b9f7545fc.png",
            shortUrl: "upload://prqsLHn6SU6wPKWSuHOu9U6uIvq.png",
          },
          {
            name: "热化了",
            url: "/uploads/default/original/3X/9/1/910da7d3a997ead6508492c664c26bdc60568016.png",
            shortUrl: "upload://kHcuo7ANtUlijJC6RP2mNJs8MpE.png",
          },
          {
            name: "我酸了",
            url: "/uploads/default/original/3X/9/6/9643b6015ce2cf0b511b1bb502e75f77ea02fa0c.png",
            shortUrl: "upload://lriGOLCt2ZooHsecDcx8PwzQZw8.png",
          },
          {
            name: "举牌牌",
            url: "/uploads/default/original/3X/6/d/6d90da43494bea32b359a28425278dac973a0406.png",
            shortUrl: "upload://fDgo9jwNKUJv6vtI7z5xUElEGEu.png",
          },
          {
            name: "豹富",
            url: "/uploads/default/original/3X/3/6/3684a60df913d681b57390e503d50ce6bc7a1363.png",
            shortUrl: "upload://7MhYS91NkwOBh08fSq5fy9Pg2nV.png",
          },
          {
            name: "虎虎生威",
            url: "/uploads/default/original/3X/6/4/6426bd1038a5a9dc527cb9c4fa8902854290157f.png",
            shortUrl: "upload://ehYK7Mv5Oab0ASdNJF5T8lpuOSz.png",
          },
          {
            name: "绿马护体",
            url: "/uploads/default/original/3X/d/6/d68b926569055d7049525d95449f4349b34d3d06.png",
            shortUrl: "upload://uBXd1gvbsuGNA9K2Wiy3WrY9Sxo.png",
          },
          {
            name: "右拜年",
            url: "/uploads/default/original/3X/0/e/0e8778ac0ea20143725f4c8cb8749bee10fe2c54.png",
            shortUrl: "upload://24wVHuAro2BPl4iGEodt584FDFi.png",
          },
          {
            name: "左拜年",
            url: "/uploads/default/original/3X/3/2/32e7a7ae520094dcce8f1bdac6c7fff014980063.png",
            shortUrl: "upload://7gkbUlL4ythguHh6ckmujL4WfAv.png",
          },
          {
            name: "拿到红包",
            url: "/uploads/default/original/3X/7/c/7c6ffbd4f4f59bac7a575230bb16a2ba637e8d5a.png",
            shortUrl: "upload://hKP852XZBTLFn7DcDvbdzzt1MRs.png",
          },
          {
            name: "嗨皮牛耶",
            url: "/uploads/default/original/3X/2/b/2b964c6da39caf3a18d98717071cacafc4be1e8e.png",
            shortUrl: "upload://6dAxKBL9eKJ25EhL3mX3G8eUViK.png",
          },
          {
            name: "烟花",
            url: "/uploads/default/original/3X/6/d/6d969a5fd9fcec55b8dc75f2f2895ad9ceab8013.png",
            shortUrl: "upload://fDsI0myqGlZN7jEsX8kKyDXt3zB.png",
          },
          {
            name: "太南了",
            url: "/uploads/default/original/3X/6/1/61bf8c2c1bf73d16903b40f1e27495c0427e83cb.png",
            shortUrl: "upload://dWIHBIZFC84NtgprpRXC3HdkWuf.png",
          },
          {
            name: "菜刀",
            url: "/uploads/default/original/3X/0/2/02ce1542aaa73e240dfe8b857593c6172fcc9880.png",
            shortUrl: "upload://oOu7yjTC1Mb3mBEGX1axIJb692.png",
          },
          {
            name: "西瓜",
            url: "/uploads/default/original/3X/5/3/53739651b9787cfaf10a5b06f3fbaa35a39b43e5.png",
            shortUrl: "upload://bUfh0YDuxOWXY85R6YFYcLOLF65.png",
          },
          {
            name: "啤酒",
            url: "/uploads/default/original/3X/7/0/709906bd2827bbf7031452023c620e0ad6142732.png",
            shortUrl: "upload://g45kIbTKHjpXLujWOblgMNEkFAm.png",
          },
          {
            name: "篮球",
            url: "/uploads/default/original/3X/9/7/97779c79dae95181a5391f59a8f5d622d704e374.png",
            shortUrl: "upload://lBWmyVE4EaEo2udRZg2Vl91lbWQ.png",
          },
          {
            name: "乒乓",
            url: "/uploads/default/original/3X/2/f/2f54d56936b37f93bd5a3f454e9b4bcd3f7060b4.png",
            shortUrl: "upload://6KIcaJbJpoT6Xy7RxdEJ7LC5UKo.png",
          },
          {
            name: "茶",
            url: "/uploads/default/original/3X/6/f/6f7f5721b4d3ae91955a6c977a5b13aa78ca2fc5.png",
            shortUrl: "upload://fUlP842hfEdALLXnA7WwejDnAdT.png",
          },
          {
            name: "咖啡",
            url: "/uploads/default/original/3X/5/4/54bc7c76eb7ad769b253090b247e3110fa6f9cb3.png",
            shortUrl: "upload://c5BW72KC1qsYkRdR9NuqiaQZP1h.png",
          },
          {
            name: "饭",
            url: "/uploads/default/original/3X/2/b/2b4a6790b7d457cbe4674361c307e4cd9b105998.png",
            shortUrl: "upload://6aXWpZM3xuZ2v7RtqwshQedqneo.png",
          },
          {
            name: "猪头",
            url: "/uploads/default/original/3X/3/9/39dd0cbf18970d5cc895c09bc15874d094130e20.png",
            shortUrl: "upload://8fSOoqZKhL1jAz2NQESYFmrYYVi.png",
          },
          {
            name: "玫瑰",
            url: "/uploads/default/original/2X/6/694f885b12749e87d455b4223e2978519c8a10e3.png",
            shortUrl: "upload://f1Cx081vqkYClArAjwuzghwuwsH.png",
          },
          {
            name: "凋谢",
            url: "/uploads/default/original/3X/6/a/6a30a23574808963758fa0ad5762fcb263bac10b.png",
            shortUrl: "upload://f9oO9xWYZf1rcjT3J3gqdlIhLPt.png",
          },
          {
            name: "示爱",
            url: "/uploads/default/original/3X/1/b/1b4459c7aa5a77bd404135fe762451edc583336f.png",
            shortUrl: "upload://3TdkBM46Ke94HZnP2KbPZAsnIyX.png",
          },
          {
            name: "爱心",
            url: "/uploads/default/original/3X/c/3/c3242bfc14d4850213368488a86a61388247ac3d.png",
            shortUrl: "upload://rQiBtFTQ9YK2xiLIIO5dUEkt2dT.png",
          },
          {
            name: "心碎",
            url: "/uploads/default/original/3X/e/3/e3637d123d94e268f2d5f1cf7f1eb1906a06b54d.png",
            shortUrl: "upload://wrzxq6b7sPZ1KeXyCyXc0AcNwW9.png",
          },
          {
            name: "蛋糕",
            url: "/uploads/default/original/3X/1/5/15790b76df7479a1b886cb8ff5c3499d520dda13.png",
            shortUrl: "upload://33XmzIoTFN2VaL6TgWOIy7YVusX.png",
          },
          {
            name: "闪电",
            url: "/uploads/default/original/3X/d/0/d0fdd341bebe5e8e90c23a5c2914bdefeba32a91.png",
            shortUrl: "upload://tOP8aXuFHXg1kdNxqO8ViVhk1WN.png",
          },
          {
            name: "炸弹",
            url: "/uploads/default/original/3X/f/0/f0fde51852e9b4a1f17a4622f6a037f6a5147378.png",
            shortUrl: "upload://ynUyJvSBptHsjuqPkYEcg2yugGs.png",
          },
          {
            name: "刀",
            url: "/uploads/default/original/3X/7/b/7b537c77acfbfb7dc588cb31b6e055703023dcd7.png",
            shortUrl: "upload://hAZB1JIAzaEqSFHLKqLQ4BmtGT5.png",
          },
          {
            name: "祈祷",
            url: "/uploads/default/original/3X/3/c/3c4e634f83d3ed9ff201bb9e3861ecf287808c68.png",
            shortUrl: "upload://8BuANMJTkPqq2JmZ9BD8OpXdwtW.png",
          },
          {
            name: "足球",
            url: "/uploads/default/original/3X/0/e/0ef29bd9b235b6927f862c6c86ff87e41ad35daf.png",
            shortUrl: "upload://28etex4NnE344Lx96js1uDbsdHx.png",
          },
          {
            name: "瓢虫",
            url: "/uploads/default/original/3X/7/f/7f33971f77f93a9915752cdfe212905f05463476.png",
            shortUrl: "upload://i9hazqpUNORN8ZPQ0pjYrKhfoHk.png",
          },
          {
            name: "便便",
            url: "/uploads/default/original/3X/1/6/16660e0a9d431bdafcab55d49aeee8b3f119b4da.png",
            shortUrl: "upload://3c99F6X86ZLy1CZnNBj01832Svw.png",
          },
          {
            name: "月亮",
            url: "/uploads/default/original/3X/5/a/5afa27f01cf45f43a798db800342638d22bee619.png",
            shortUrl: "upload://cYOVBw5lSZGE0yizj7MKK1oCOrn.png",
          },
          {
            name: "太阳",
            url: "/uploads/default/original/3X/4/d/4d599755ace311c9726b80e48a4650b79e20b304.png",
            shortUrl: "upload://b2gIeexemJEe8qQrwiXCDz30Q2E.png",
          },
          {
            name: "礼物",
            url: "/uploads/default/original/3X/8/7/87cd5efc30cfd4036634806efe6ce061f9b0e4a7.png",
            shortUrl: "upload://jnmsLkm6foKR1rgwxXms1TAJuZN.png",
          },
          {
            name: "拥抱",
            url: "/uploads/default/original/3X/a/6/a63cf81e0694dae6cade48b12e1e576f6dedc4f7.png",
            shortUrl: "upload://nIBSVRvK3DWWHrcIxZoEN0hDquP.png",
          },
          {
            name: "赞",
            url: "/uploads/default/original/3X/d/2/d24e8331d0d67514c837492ab945467992fb1759.png",
            shortUrl: "upload://u0stOYQhq5bNSVSjXUUnQZLNWFX.png",
          },
          {
            name: "踩",
            url: "/uploads/default/original/3X/e/4/e4c1aa49852be08ffe9f1107fcb04cfd859a56ba.png",
            shortUrl: "upload://wDFMUWgBy5VEbpFflsG4Vqs0ivM.png",
          },
          {
            name: "握手",
            url: "/uploads/default/original/3X/6/4/64c2d7e686e1d40cfbd79474189bad3dd8a3319e.png",
            shortUrl: "upload://enncdlGgUvC9GjUiMhEZpbxLWQC.png",
          },
          {
            name: "胜利",
            url: "/uploads/default/original/3X/b/3/b371bd1cb36083aa8766b1b60cdf1f0de6872586.png",
            shortUrl: "upload://pBr9nzd3P4TpKbYJli8lhY8fY5o.png",
          },
          {
            name: "抱拳",
            url: "/uploads/default/original/3X/b/f/bf12d57b7c09880e078235e49487300f397ed10c.png",
            shortUrl: "upload://rgjxZNf7IoHjKj1a8TlOCqiH6EY.png",
          },
          {
            name: "勾引",
            url: "/uploads/default/original/3X/5/1/51e744fface98835068e63b8f173a7c228c78a03.png",
            shortUrl: "upload://bGyaoWYxw8Vkkluvg26SzfXJPBp.png",
          },
          {
            name: "拳头",
            url: "/uploads/default/original/3X/d/c/dc5c95df97cc4f471fd98e751e931a13fe947453.png",
            shortUrl: "upload://vrppe6C0CzeLiTqkfmTCjqyWJjR.png",
          },
          {
            name: "差劲",
            url: "/uploads/default/original/3X/f/4/f4b2f9439f430eb19923efe994198451f4a06cf8.png",
            shortUrl: "upload://yUHX23ujVhaXQxTrBr2hfTkgNgQ.png",
          },
          {
            name: "爱你",
            url: "/uploads/default/original/3X/c/7/c72faffed59c4ab6f88bafb7170a4ae3421722dd.png",
            shortUrl: "upload://sq5bzcX5E4xhpHVbd9nGZeDFsAd.png",
          },
          {
            name: "NO",
            url: "/uploads/default/original/3X/b/5/b52360293b4834d8d60d708da08c4bb0ef420909.png",
            shortUrl: "upload://pQqdgWXXSAK8o5tO2nu6x7x4bmV.png",
          },
          {
            name: "OK",
            url: "/uploads/default/original/3X/6/0/60149b67d707fc242f13fc5a481c934ca6465182.png",
            shortUrl: "upload://dHXZedPbw1qZ66L25oCTHzJlPDY.png",
          },
          {
            name: "爱情",
            url: "/uploads/default/original/3X/0/c/0ce434bfa5fec9948e2051770694b5cf3130bacf.png",
            shortUrl: "upload://1Q2EQCFTJukeMhk3rPPffLyInCv.png",
          },
          {
            name: "飞吻",
            url: "/uploads/default/original/3X/5/4/54671743329a6c305a3f22779bf3f1422710f11f.png",
            shortUrl: "upload://c2EYG4j6Wt9ts9VsO2n4KIXxCEL.png",
          },
          {
            name: "跳跳",
            url: "/uploads/default/original/3X/9/2/928f62148deab2e9f8604bf68fe1331206a90cff.png",
            shortUrl: "upload://kUwUgSqMnslvegSVHqbGVm6xlo3.png",
          },
          {
            name: "发抖",
            url: "/uploads/default/original/3X/d/f/df59465e768baf668bd4a909c64e374c578e3f54.png",
            shortUrl: "upload://vRPKhnnb1ZWztpNWukKKX2mmEqU.png",
          },
          {
            name: "怄火",
            url: "/uploads/default/original/3X/b/0/b0cb1fd0c8865d5e8da3914a6e592f4425d015ad.png",
            shortUrl: "upload://pdZe2TN9NVNDL2fce2ixkzgJ43H.png",
          },
          {
            name: "转圈",
            url: "/uploads/default/original/3X/e/0/e04d37edfb15d04f67e0806b35136b00a917278f.png",
            shortUrl: "upload://w0gonsEVrkyQOBBnjXTq5wreWxF.png",
          },
          {
            name: "磕头",
            url: "/uploads/default/original/3X/c/c/ccc35ee45f86130b7c5b039ef77db46376d9c3bc.png",
            shortUrl: "upload://tdpYZmL7KQPMi76O1wQe3CQxXeQ.png",
          },
          {
            name: "回头",
            url: "/uploads/default/original/3X/0/8/08e7c69a23e554268a0f5fb6736f93b85aad6b68.png",
            shortUrl: "upload://1gMoCsCmgqMFVtftwq7POHk1BsQ.png",
          },
          {
            name: "跳绳",
            url: "/uploads/default/original/3X/9/0/9001251705f719e8709af3b50a53c3c863300048.png",
            shortUrl: "upload://kxVcW1Lg54CBSJinPRNbtCyNwOk.png",
          },
          {
            name: "挥手",
            url: "/uploads/default/original/3X/f/9/f911a73e75461b7938bb786fc0e19103ce81dfaa.png",
            shortUrl: "upload://zxmI9wExqkUXYEuEjpqbD9sBnLQ.png",
          },
          {
            name: "激动",
            url: "/uploads/default/original/3X/0/d/0d6369a1fd32557e1d9c2fbf262dcc4115430f58.png",
            shortUrl: "upload://1UrcfUPGbRHURb4Cm57OX7YMH6o.png",
          },
          {
            name: "街舞",
            url: "/uploads/default/original/3X/7/d/7dee9dde84844c76ef2c8c943354c8a0dc78bc17.png",
            shortUrl: "upload://hY2UTylTAmaY7hcasI04cVwAKrl.png",
          },
          {
            name: "献吻",
            url: "/uploads/default/original/3X/a/5/a5e1ecc1a24771d63fc32dd688d0ea764830fd80.png",
            shortUrl: "upload://nFsP6L6DAEsmJgCIsuhOwsREsqQ.png",
          },
          {
            name: "左太极",
            url: "/uploads/default/original/3X/6/7/675ea3296299a681cb1d131d295812f7148bdeb0.png",
            shortUrl: "upload://eKrWdGtWmsKaaW5tfWA3wT5z9vO.png",
          },
          {
            name: "右太极",
            url: "/uploads/default/original/3X/1/b/1b6ea69004bb62ff6f578bc04a74a7a5d982ba4d.png",
            shortUrl: "upload://3UFXuGcOya129Brnh5WtCJdo0k5.png",
          },
          {
            name: "双喜",
            url: "/uploads/default/original/3X/5/0/5090318ce758f142577971cb6dcc9edd73a1c5f3.png",
            shortUrl: "upload://buH87cqShuTbMAvaBC4tQjAYvNp.png",
          },
          {
            name: "灯笼",
            url: "/uploads/default/original/3X/3/2/32ce482c5257121f5496afd72ed30e1ab5a0de57.png",
            shortUrl: "upload://7frPuu5m3wviijEReeDhgq3aNTx.png",
          },
          {
            name: "K歌",
            url: "/uploads/default/original/3X/3/5/3593122c004f56f153fb24ff68a2638fb39d0cb9.png",
            shortUrl: "upload://7DWp3dFvTBEgwbahzjpgaEeo0xr.png",
          },
          {
            name: "喝彩",
            url: "/uploads/default/original/3X/f/b/fb98a45fb0bc49d6ddd2213706b3ee79ac5c9768.png",
            shortUrl: "upload://zTISvNWtQ0U42MYhxhgbO80VdJm.png",
          },
          {
            name: "爆筋",
            url: "/uploads/default/original/3X/7/2/72d8a3db6c92f8e24ab03b1932d8d0ce0e13d728.png",
            shortUrl: "upload://gnYA0IYDiOLEmiDeJFuicjO3W2s.png",
          },
          {
            name: "棒棒糖",
            url: "/uploads/default/original/3X/a/c/ac21312d937e25714080f339f79a53ba2a459ab6.png",
            shortUrl: "upload://oyJeNr3FLVrZIR6Ow1Am39yCk3s.png",
          },
          {
            name: "喝奶",
            url: "/uploads/default/original/3X/1/b/1b9c0a5d012f07400dec03780703e2a2348336f6.png",
            shortUrl: "upload://3WfcPicuEPE0tW6WFfpWSqBJiiG.png",
          },
          {
            name: "飞机",
            url: "/uploads/default/original/3X/0/4/04712a0b7a6080365ed7962f9dd7b313921def3d.png",
            shortUrl: "upload://DimvV5qCln5h1Na01GUzGJDzLT.png",
          },
          {
            name: "钞票",
            url: "/uploads/default/original/3X/6/a/6ae76c918fc046a24fd28cbb67d10c5204dab45d.png",
            shortUrl: "upload://ffIr0R7wN8BdbddCoLF8qJ5VLlz.png",
          },
          {
            name: "药",
            url: "/uploads/default/original/3X/f/a/fac7679efd1397647a28ffe4fff35b26214a7318.png",
            shortUrl: "upload://zMuABlzsozPgJSxBq8fJP9uvyY0.png",
          },
          {
            name: "手枪",
            url: "/uploads/default/original/3X/f/1/f1510aa050bdedd928db3b3caca49f55657a4826.png",
            shortUrl: "upload://yqMHsGhsWpP6Fe58JqlLW0lO5dI.png",
          },
          {
            name: "蛋",
            url: "/uploads/default/original/3X/c/e/ceea7d0229eeb87e56d0f67db20f5b4b84838084.png",
            shortUrl: "upload://twsKmzMwoYmsbZ5kEMrFiaJEGr2.png",
          },
          {
            name: "红包",
            url: "/uploads/default/original/3X/5/f/5fa94bec644a7fdd246e794a4517cf262b6d9e9d.png",
            shortUrl: "upload://dEg4HT4I2Y0LyoKh6AcpjRoilbf.png",
          },
          {
            name: "河蟹",
            url: "/uploads/default/original/3X/8/e/8ecf1da1cd072c3512b644d47c00f970b32f869c.png",
            shortUrl: "upload://knlxK6t46M1V3vbgOvvcdklKQhe.png",
          },
          {
            name: "羊驼",
            url: "/uploads/default/original/3X/a/9/a911cbae09d5bf444aa3f4cd808b8bc52c350c5f.png",
            shortUrl: "upload://o7EONZ8a17ykMrBz0Sbqszuryd9.png",
          },
          {
            name: "菊花",
            url: "/uploads/default/original/3X/2/6/26de50e37b4d3b970887129b2b156c32ba50fa14.png",
            shortUrl: "upload://5xQs7P7qPKPWCbXbjOfIY0U2Hcg.png",
          },
          {
            name: "幽灵",
            url: "/uploads/default/original/3X/8/8/88c15740934bb64247bbdc156faac597ea5b0566.png",
            shortUrl: "upload://jvNalaolICaZyRtYe1SpXUFOtMi.png",
          },
          {
            name: "大笑",
            url: "/uploads/default/original/3X/1/a/1a3c976896ee9ad61473aa89e2356d0022554430.png",
            shortUrl: "upload://3K6ejaiDHtvsjtqpi3hOQwZSbwA.png",
          },
          {
            name: "不开心",
            url: "/uploads/default/original/3X/8/5/85cd1e77d0bb994e03e159f93348966d91ec41b7.png",
            shortUrl: "upload://j5EY4XYaBnzhGL938RDhCnBAk4v.png",
          },
          {
            name: "冷漠",
            url: "/uploads/default/original/3X/9/c/9c62c86e8df62a02b1162e29737e7f2ad1316162.png",
            shortUrl: "upload://mjs7RDpVdmPfygaAV0ioJRuAL18.png",
          },
          {
            name: "呃",
            url: "/uploads/default/original/3X/0/2/0279aa402cfa1f8f4b980eb9d966a1d54e673210.png",
            shortUrl: "upload://lTCvtibCGmkK5OgQu0lP9eKWzu.png",
          },
          {
            name: "好棒",
            url: "/uploads/default/original/3X/6/4/64411fd2a074c5780b7ff9d08cc741392c050cd8.png",
            shortUrl: "upload://eiTh3Z9mBbr6wBvtDzvFgvVigsM.png",
          },
          {
            name: "拜托",
            url: "/uploads/default/original/3X/a/0/a0cab05a8a6be01872a10b0e9d55f81f585a014a.png",
            shortUrl: "upload://mWqEyJE4gUOMrhKFARl7LbBZgMy.png",
          },
          {
            name: "点赞",
            url: "/uploads/default/original/3X/7/5/75a6d5c40e22ccc69edd8d8d4807cd97af66638c.png",
            shortUrl: "upload://gMNiZUWLaFihwI1ZavDdg2IEpic.png",
          },
          {
            name: "无聊",
            url: "/uploads/default/original/3X/3/b/3bb2a4806b5842622d90b01e66f3aa5eb05cd31d.png",
            shortUrl: "upload://8w6UsQ8E3uT3TRcHWzCTSojngqp.png",
          },
          {
            name: "托脸",
            url: "/uploads/default/original/3X/6/6/66377a52fa400a51602656f464354c41944ed839.png",
            shortUrl: "upload://eAfySXHGv71dpAKsQmsFaRvSUE9.png",
          },
          {
            name: "吃",
            url: "/uploads/default/original/3X/4/e/4e81083806199ad0169e8e75ac1ab87fa779d8ff.png",
            shortUrl: "upload://bctGWKVtVb4rOtTxLyO4Rez4P6L.png",
          },
          {
            name: "送花",
            url: "/uploads/default/original/3X/e/f/ef9748790ce9d71e05e7d404b45fc4e4690db736.png",
            shortUrl: "upload://ybweKMOHofctqjhLt1qc5yle05w.png",
          },
          {
            name: "害怕",
            url: "/uploads/default/original/3X/1/b/1b5e818f87034813609d41bf66bed6aadd9aba05.png",
            shortUrl: "upload://3U7mWAl2YoAqHcEFcBfPuLD6sxT.png",
          },
          {
            name: "花痴",
            url: "/uploads/default/original/3X/e/b/eb5f911a65042cbea1fee68187f556fdf1514ed0.png",
            shortUrl: "upload://xAcXiMC6Qli3NeHAQqFoPvzgq3u.png",
          },
          {
            name: "小样儿",
            url: "/uploads/default/original/3X/1/2/12cdb7779701af18928a236ca66c3169f98af710.png",
            shortUrl: "upload://2Gll6ujsGZvPUx3svD5mfLl5eIE.png",
          },
          {
            name: "飙泪",
            url: "/uploads/default/original/3X/3/1/3130256a05fa08d540be64e415466b62f4a92bc6.png",
            shortUrl: "upload://718y1cIapPRYOJPdbgzxwskmVq6.png",
          },
          {
            name: "我不看",
            url: "/uploads/default/original/3X/7/0/70383e135b36384b08a6b110641933068b415b5c.png",
            shortUrl: "upload://g0JYupGoziT5at9whJWhUx03ac4.png",
          },
          {
            name: "汗",
            url: "/uploads/default/original/3X/1/2/1258583ccdd0e63a0e339b4b068c3866a8ab52c2.png",
            shortUrl: "upload://2ChS4e3JgPGLLDO8XZ5Nif3tmRI.png",
          },
          {
            name: "打脸",
            url: "/uploads/default/original/3X/c/6/c6fdcfa43782c4eb6bbdd428388e177b502e1c2c.png",
            shortUrl: "upload://somkgGAqBzh0qBKOGVuhyZMRm4A.png",
          },
          {
            name: "击掌",
            url: "/uploads/default/original/3X/5/f/5fa721b7cd6c94a1b1f3e685bb4b30dd0ff9e8aa.png",
            shortUrl: "upload://dEbr8DJ1AA6NgrWyJuKEHmYXlyO.png",
          },
          {
            name: "头撞击",
            url: "/uploads/default/original/3X/5/e/5ee8a647d66efdc7e8e35daee156fbab8f0d6cb7.png",
            shortUrl: "upload://dxBkytt1BWtwFEvXlySLIfrYyrR.png",
          },
          {
            name: "甩头",
            url: "/uploads/default/original/3X/d/7/d79706e648dd29d6b9f5039435873dd821c13478.png",
            shortUrl: "upload://uLcefJ1hcOpDgWmSxcR27AgNI0g.png",
          },
          {
            name: "扔狗",
            url: "/uploads/default/original/3X/5/f/5f846790ac1256b1848726e8cf49166c14328f40.png",
            shortUrl: "upload://dCZ2b3Lpb20aZFSuGoHibc7LFyE.png",
          },
          {
            name: "糊脸",
            url: "/uploads/default/original/3X/2/1/21c4b8b4eca94c6061f8bc524b19902c86fb1bc1.png",
            shortUrl: "upload://4OJehIYDu6bs9AF6YRzCZndbhjb.png",
          },
          {
            name: "偷看",
            url: "/uploads/default/original/3X/c/1/c15cd922efaa6da2d805af412e70d7936cb54714.png",
            shortUrl: "upload://rAz4QjlqMbHJEXGuDFOVa9Cww1m.png",
          },
          {
            name: "拍桌",
            url: "/uploads/default/original/3X/4/c/4cdef4920d27c480ba9c5dc133e9688703767f3e.png",
            shortUrl: "upload://aY1XYFzYXMtVvSusZElopAr16Ee.png",
          },
          {
            name: "啵啵",
            url: "/uploads/default/original/3X/5/9/59da0c1519983e50996c0d191977572a31cbaef9.png",
            shortUrl: "upload://cOREQyO593QtZMQaThAVMbI1w2B.png",
          },
          {
            name: "扯一扯",
            url: "/uploads/default/original/3X/6/7/673d872b2c86568818f095e3c9d8129b28768d11.png",
            shortUrl: "upload://eJj09Y9BwOpf7V0qHcKFDrTsSfD.png",
          },
          {
            name: "喷脸",
            url: "/uploads/default/original/3X/f/c/fc4e9adba9137df0d930e69b66450aa5ca6faca1.png",
            shortUrl: "upload://A00JqU0yNHIIwg4zCDQSCwUtIVb.png",
          },
          {
            name: "拍头",
            url: "/uploads/default/original/3X/a/6/a60eb6c41567faf9ce949c18fc9a300922fea57d.png",
            shortUrl: "upload://nH0MDMAvVfs6DzHp7hKMoFJrhXn.png",
          },
          {
            name: "舔一舔",
            url: "/uploads/default/original/3X/5/6/5673cbbcae74ca4b9ce11f1f944902196390a58e.png",
            shortUrl: "upload://ckN9xF3cjBrfBIYZ4HczUjDkKAK.png",
          },
          {
            name: "干杯",
            url: "/uploads/default/original/3X/4/2/42fef0dfb4f1c0269bfc7efc9837ac3fceaecd85.png",
            shortUrl: "upload://9yFIJcO4DyPszptz6x3Dvgyc5CZ.png",
          },
          {
            name: "扇脸",
            url: "/uploads/default/original/3X/b/5/b529664e58aca2f878fa34aa29755e673f417480.png",
            shortUrl: "upload://pQD7t203UyVE8rDdMysWOqDQVeE.png",
          },
          {
            name: "蹭一蹭",
            url: "/uploads/default/original/3X/c/e/ceed6676bae3726005897c331811231862727048.png",
            shortUrl: "upload://twyZauxXCz9ssd6G6byFl6BAWxO.png",
          },
          {
            name: "撩一撩",
            url: "/uploads/default/original/3X/2/5/25e1e6480e49be35a8a135f38ce64fe8f476195f.png",
            shortUrl: "upload://5p7ExIq0ENLTwIN6qSCWfVtQh1d.png",
          },
          {
            name: "哼",
            url: "/uploads/default/original/3X/8/4/84bedbde1c6980a99bd2e12f516f8f90a6a9d6d2.png",
            shortUrl: "upload://iWjWeJp8d5MUTouG5ShNVEDaMhk.png",
          },
          {
            name: "掐一掐",
            url: "/uploads/default/original/3X/4/3/43dfb9b81a53d8ef345cee0dce1e4f7361a09135.png",
            shortUrl: "upload://9GrjQxlY2jWtGy6prR6ZJxj7vlb.png",
          },
          {
            name: "顶呱呱",
            url: "/uploads/default/original/3X/6/b/6b6e4b1d6b594d2a05da6f20825c5c59c49cc14c.png",
            shortUrl: "upload://fknoirGoVGQ9JYUByXgv7lefDQg.png",
          },
          {
            name: "抱抱",
            url: "/uploads/default/original/3X/5/0/50674b6f4997823e89982c2fcb15b8394c69cd72.png",
            shortUrl: "upload://bthvkUgIBQs2n7K4btH79z4Bm6K.png",
          },
          {
            name: "原谅",
            url: "/uploads/default/original/3X/a/d/adcf1702016e8a49921873c5f8067bc1db5268ce.png",
            shortUrl: "upload://oNAi0hMTGEtobc1zEmZHRUbjYBg.png",
          },
          {
            name: "佛系",
            url: "/uploads/default/original/3X/d/5/d5c3647c6e008763d039d0c197cd361b2dbc7b2f.png",
            shortUrl: "upload://uv2kjTDIVAeHq8Iu0cwdvTTC8yP.png",
          },
          {
            name: "拽炸天",
            url: "/uploads/default/original/3X/8/4/843b89efa0a5b82b64bb9ba86230ad8b29e766ae.png",
            shortUrl: "upload://iRMAq1WPN7Lr8N7OzlQuKeZDmgu.png",
          },
          {
            name: "颤抖",
            url: "/uploads/default/original/3X/1/d/1d565cd88787a28a0b2eb1afce5e138f2640974a.png",
            shortUrl: "upload://4bwSqnjNCKBRz0Q62eagJyKPqDE.png",
          },
          {
            name: "生日快乐",
            url: "/uploads/default/original/3X/a/c/ac0394d60ecf22ba2301c6cbb489c129d1bbf381.png",
            shortUrl: "upload://oxHNtyKLTK3eluVcFcGe6wwatfX.png",
          },
          {
            name: "嘲讽",
            url: "/uploads/default/original/3X/d/4/d49f0e82bdbf5ab68ee1129a967c9bdd1eba1942.png",
            shortUrl: "upload://ukW04fwgLGrBpKUvtVe1IBQlVVo.png",
          },
          {
            name: "开枪",
            url: "/uploads/default/original/3X/0/1/0149aaf70582cc54c6820e624622c270907bd2c6.png",
            shortUrl: "upload://bojdUQSJA0awMQkWuuGiKmKuHQ.png",
          },
          {
            name: "啃头",
            url: "/uploads/default/original/3X/7/5/750063281ec55fe38f8725e437ff3c5374bbea25.png",
            shortUrl: "upload://gH2H1kFeMTNLuPftIVaMwoqVWL3.png",
          },
          {
            name: "恭喜",
            url: "/uploads/default/original/3X/5/2/521a331e7805200c002a49be45d27c9e13b84660.png",
            shortUrl: "upload://bIjhG4Toc4Vwnw3BYHzGxvYZ8kM.png",
          },
          {
            name: "惊呆",
            url: "/uploads/default/original/3X/4/0/40e1f08cd7847a4034b4074f35de238e1bcf76dd.png",
            shortUrl: "upload://9fYD9LQZlNSS11RikErELLHotzv.png",
          },
          {
            name: "暴击",
            url: "/uploads/default/original/3X/7/c/7c4e3f909c6ba695fbc94f08941bb49b96ffcb03.png",
            shortUrl: "upload://hJEQRbzTH4XqqrrBNBxr0BnQL2r.png",
          },
          {
            name: "拍手",
            url: "/uploads/default/original/3X/5/e/5ef787827455fe69afdf870f00f3361c3a981ce9.png",
            shortUrl: "upload://dy7d6wCiDgWNHjeT28Bn8hxd6jL.png",
          },
          {
            name: "1000",
            url: "/uploads/default/original/3X/d/1/d1843e832161dc1ade2889ff748de6d638a45d32.gif",
            shortUrl: "upload://tTt7DxOaEA8NXxfdUdcKkTXNBui.gif",
          },
          {
            name: "1001",
            url: "/uploads/default/original/3X/0/d/0dc17563fde24c721472220bd35cd74572106bbf.gif",
            shortUrl: "upload://1XGGMZ54HwratU401sjpehLnu91.gif",
          },
          {
            name: "1002",
            url: "/uploads/default/original/3X/c/0/c0872030d44d61dfab95ed5a640d5dfd53f76ae5.gif",
            shortUrl: "upload://rtbb9xaKD4FwP8RLQ5sO4DwwTsx.gif",
          },
          {
            name: "1022",
            url: "/uploads/default/original/3X/8/0/8041a5a0932493953007feeaff11d86e43070def.gif",
            shortUrl: "upload://iiBLnGzTrYWaQy7AzxcyJ5Lm9sz.gif",
          },
          {
            name: "1028",
            url: "/uploads/default/original/3X/5/6/56a5e546de7d3305f56ad990d456bc913b03b0ad.gif",
            shortUrl: "upload://cmwuvTL79vLoIzxsv0HM63yFAO9.gif",
          },
          {
            name: "1017",
            url: "/uploads/default/original/3X/2/6/26b3e632c7352ed6bc798643f3a9541eef89fdab.gif",
            shortUrl: "upload://5wnzILv5DrZWsqNfMGmCVrnBTYv.gif",
          },
          {
            name: "1027",
            url: "/uploads/default/original/3X/d/4/d410def3420164d544cf50b3fb7f96090c287d1a.gif",
            shortUrl: "upload://ug1mUf7923qL3fIo32sMbk310nw.gif",
          },
          {
            name: "1029",
            url: "/uploads/default/original/3X/2/8/287e2a6245bb9b0f68bc558d03038d40c285177a.gif",
            shortUrl: "upload://5MdpfC7o4KLlYIGyqnWwI8572Xg.gif",
          },
          {
            name: "1014",
            url: "/uploads/default/original/3X/3/2/3299c099563697509993238b7fbb93f2dbc89b56.gif",
            shortUrl: "upload://7dDhKT13y2Mnv9YzVy4k5ODhwAS.gif",
          },
          {
            name: "1024",
            url: "/uploads/default/original/3X/1/6/16e3c359f5fb95385d0330e854280080655c0ec6.gif",
            shortUrl: "upload://3guu2vl3UbiHEkUzdjka2posd2m.gif",
          },
          {
            name: "1030",
            url: "/uploads/default/original/3X/5/6/5668e8791fc6312dc9e0f6380622bdf9a831755b.gif",
            shortUrl: "upload://ckpPh4Be8WKGlyjq9bBJgO4BkzV.gif",
          },
          {
            name: "1042",
            url: "/uploads/default/original/3X/f/b/fb00d6444fd3e9903917e3bf6a75f061f6d27d1f.gif",
            shortUrl: "upload://zOtDzDFaoa2rtbiqUJp1UNf9VtJ.gif",
          },
          {
            name: "1040",
            url: "/uploads/default/original/3X/d/0/d074534f6d53f3d82af7b7a0852ca2bc932e9eb2.gif",
            shortUrl: "upload://tK4xtwEfYl93wkor2Vbn6IjcSTU.gif",
          },
          {
            name: "1034",
            url: "/uploads/default/original/3X/7/9/79c63721ee107668f1b716cf4d44a222c8de2cb8.gif",
            shortUrl: "upload://hngrNyXXZKqCOA3SN5uSsgxIqvu.gif",
          },
          {
            name: "1070",
            url: "/uploads/default/original/3X/0/1/015aadf0bef4bec5d573650a259324eef362dc7d.gif",
            shortUrl: "upload://bYKX5hcVE5eE3NAFIkWfQ1Z24l.gif",
          },
          {
            name: "1071",
            url: "/uploads/default/original/3X/2/7/274c7176b44e455a9d31b2398d93bfea306aa1f3.gif",
            shortUrl: "upload://5BEoOjsXqn68F5jUFy4xpwvnUl5.gif",
          },
          {
            name: "1072",
            url: "/uploads/default/original/3X/d/d/dd026c74bf4a3f88ddd9f4b5f037a3347bfe242c.gif",
            shortUrl: "upload://vx8IfbOt7OUoMp959vWVXHj1CPO.gif",
          },
          {
            name: "1073",
            url: "/uploads/default/original/3X/e/2/e28d057a8d1c2d94d4792a6aa458999f00920ce2.gif",
            shortUrl: "upload://wka2O3xg3U1taeBhNFG7qJWzOSu.gif",
          },
          {
            name: "1074",
            url: "/uploads/default/original/3X/e/6/e653e56f1af4488c830f26ca739fa9708a4dec36.gif",
            shortUrl: "upload://wRzz20NdfyjL8QYovYaiuyxQW2y.gif",
          },
          {
            name: "189",
            url: "/uploads/default/original/3X/5/e/5e4c4cb2462ab741c88f9960d409cde7cccfb6ba.png",
            shortUrl: "upload://dsclUhsFIMZa3VGMnJJkRnuySE2.png",
          },
          {
            name: "195",
            url: "/uploads/default/original/3X/6/5/654c8054e86c33ea92d94fd5541908aacb27bfa4.png",
            shortUrl: "upload://es87VcNJdcjTl6srvx5Km0gnCGo.png",
          },
          {
            name: "196",
            url: "/uploads/default/original/3X/1/3/1374aeed9e4361b9474c34423841162f7c087c07.png",
            shortUrl: "upload://2M7411TQFxW7DwWimOhFJzqmTMX.png",
          },
          {
            name: "209",
            url: "/uploads/default/original/3X/4/3/43778c8599b3cfaac92fcafcb5c23f11ee2c68b2.png",
            shortUrl: "upload://9CQ7Cnde8R6CddCdJZxSTgsZKL0.png",
          },
          {
            name: "213",
            url: "/uploads/default/original/3X/8/e/8e1bd92a5b8967ac5d44f57ea5032e8e4c701373.png",
            shortUrl: "upload://kh9sRrHzc3KtD8hUhauXcWBtO03.png",
          },
          {
            name: "亲亲",
            url: "/uploads/default/original/3X/2/d/2dddd6d0f50b60084023629171cca6bb3993778d.png",
            shortUrl: "upload://6xKM0qGsGiPaPcy8d8d211tjsQJ.png",
          },
          {
            name: "栗子",
            url: "/uploads/default/original/3X/a/b/abbcfffad8e79889365a08dd10aa0898116d0ffe.png",
            shortUrl: "upload://ovgzPukoSRnDxpoHdoOCvQlOr2m.png",
          },
          {
            name: "肥皂",
            url: "/uploads/default/original/3X/9/e/9e47807210a0a127a5d4e75d6998ee4c90ec2826.png",
            shortUrl: "upload://mAcDbNWS4Hje9d7bovxOKkWWHvE.png",
          },
          {
            name: "下雨",
            url: "/uploads/default/original/3X/2/0/20d200849b84dfe7ed36eb913951d4ce6f2f4a9a.gif",
            shortUrl: "upload://4GlcN4wKOwd683TpFXGryN9N4M2.gif",
          },
          {
            name: "不你不想",
            url: "/uploads/default/original/3X/a/b/ab4906d84bb628b3245fbc9dd6c7c716ba5a1962.gif",
            shortUrl: "upload://org6BqB0bi9B9QdO8WMfNVfiNUe.gif",
          },
          {
            name: "中国象棋红帅",
            url: "/uploads/default/original/3X/1/f/1f110f7e2c5fef0fa6c3bfc564f524a7e160ce14.gif",
            shortUrl: "upload://4qPlV9n5N1XhCHAkKkc3wmJjK1C.gif",
          },
          {
            name: "云",
            url: "/uploads/default/original/3X/2/c/2c6191b7b77d4ef50df19ae1916b73cd7efc23d3.gif",
            shortUrl: "upload://6kC35iTIkWBanYkqFfq3RE9tvRp.gif",
          },
          {
            name: "伞",
            url: "/uploads/default/original/3X/4/1/41f2307151be00e586fabbc9b25a3e6f11e2f74b.gif",
            shortUrl: "upload://9pnVgm02BNNgkptYh7sDioak2SL.gif",
          },
          {
            name: "信封",
            url: "/uploads/default/original/3X/2/7/27f35236ebb9355431fb135fa9123d409bf92da0.gif",
            shortUrl: "upload://5HpVWftMgMapjK03QG2qf4huMXS.gif",
          },
          {
            name: "卷纸",
            url: "/uploads/default/original/3X/5/2/521754592086865d41fee28236b26dfa69c0cb16.gif",
            shortUrl: "upload://bId8pThpbswb454BKJjRyvf2szI.gif",
          },
          {
            name: "哇哦",
            url: "/uploads/default/original/3X/d/3/d3b57a74b3bcc97fa5c77ce167dc498290b8fa58.gif",
            shortUrl: "upload://ucRyPDTA6YyoI4jpFbwYz8tAwmk.gif",
          },
          {
            name: "戒指",
            url: "/uploads/default/original/3X/d/2/d273e1b30ed922dde9fa9433b6484e309737d0f9.gif",
            shortUrl: "upload://u1KxJmEpomuhHWLHfxJt1j0TwbD.gif",
          },
          {
            name: "手提包",
            url: "/uploads/default/original/3X/4/c/4cdb78d9f2d2463965ec891384d99562492fa7e0.gif",
            shortUrl: "upload://aXUvhkh4xhvgdIwVxXO8HzDg0ve.gif",
          },
          {
            name: "打call2",
            url: "/uploads/default/original/3X/0/7/075380edc4d5314558625e0b33d1c153bec1eb68.gif",
            shortUrl: "upload://12OfnhePJiTkYmlFjiLA8f9MJv2.gif",
          },
          {
            name: "打脸2",
            url: "/uploads/default/original/3X/c/f/cf33fa2a1512ce567181a232eac19ab66a22843e.gif",
            shortUrl: "upload://tz0cdnPwBW0WhKYUpph67V37fuC.gif",
          },
          {
            name: "气球",
            url: "/uploads/default/original/3X/4/4/44dfb5c84bfad88ee8db8c81b4e6aa93a12281d8.gif",
            shortUrl: "upload://9PhLphJPFItYbkUkOaxF4yMqTaw.gif",
          },
          {
            name: "汽车",
            url: "/uploads/default/original/3X/7/1/71f24d02935d2620d6bad1c8cc26b455f11a26d8.gif",
            shortUrl: "upload://gg152q0zXrs6Zlny0EgAST6sNcc.gif",
          },
          {
            name: "沙发",
            url: "/uploads/default/original/3X/1/0/10a514109286f7233012955043785f85736d74b9.gif",
            shortUrl: "upload://2nfjJCIBCxgv4PppIsqlt6XeBol.gif",
          },
          {
            name: "没眼看",
            url: "/uploads/default/original/3X/1/b/1bfafa8b4d183ec3dc2fe74adaeb6943334eea50.gif",
            shortUrl: "upload://3ZwBSV29QUvDkEa32yYCtyRg9yw.gif",
          },
          {
            name: "滚",
            url: "/uploads/default/original/3X/f/d/fd92c1928baa36d418f850978098b713e56ff572.gif",
            shortUrl: "upload://AbddRyapYbODXzy04oOiedhoVXk.gif",
          },
          {
            name: "灯泡",
            url: "/uploads/default/original/3X/0/4/04c24faf4e835d8f4ee7f41f549040601da10a82.gif",
            shortUrl: "upload://G6dD7BH0VnK7rBLVeRiiLn7xpo.gif",
          },
          {
            name: "熊猫",
            url: "/uploads/default/original/3X/c/3/c35ae2f05563218a9ace1b5bf32f17c16329cac5.gif",
            shortUrl: "upload://rSbPsZnvYVBVRgDfbN7NvKiigD3.gif",
          },
          {
            name: "考虑中",
            url: "/uploads/default/original/3X/9/d/9d0d12c73827abdfc1fd0917a721bd31d201035a.gif",
            shortUrl: "upload://mpkYhRsvNGlQjt1oxDVtSi9DEHU.gif",
          },
          {
            name: "闹钟",
            url: "/uploads/default/original/3X/9/d/9ddd694a2843a8d8a0ac4fde52d42defab3daa5a.gif",
            shortUrl: "upload://mwxkJgAWJDAe9xHhyKqjDZ0lXLk.gif",
          },
          {
            name: "青蛙",
            url: "/uploads/default/original/3X/0/d/0d6e6b2942ec2e39d3d1bdeb05c900f8a2e2139f.gif",
            shortUrl: "upload://1UOMe8CjJvVFLPK28Twi7HZZGI7.gif",
          },
          {
            name: "面条",
            url: "/uploads/default/original/3X/3/b/3bc989bfd409bd455606a8f0955dd9dc82848e55.gif",
            shortUrl: "upload://8wTXM24ulShPMEzXe7sS9up7UUd.gif",
          },
          {
            name: "风车",
            url: "/uploads/default/original/3X/6/d/6d31218bb8ff79606371d5f07d1835f85adb2f24.gif",
            shortUrl: "upload://fzXj2gVsz7slVlMgnOokFfy7ElC.gif",
          },
          {
            name: "香蕉",
            url: "/uploads/default/original/3X/f/a/fab0eeaa93cc41be8f1a61beff3572291e6274d4.gif",
            shortUrl: "upload://zLIru1Q3z3EI8bhv0OlHkOfMzn6.gif",
          },
          {
            name: "高速列车1",
            url: "/uploads/default/original/3X/2/1/217b6b9370034c77233dedd07e3dbc5c9bc4fc2c.gif",
            shortUrl: "upload://4McblVqn3pHisNjWAyFB4tjm47a.gif",
          },
          {
            name: "高速列车2",
            url: "/uploads/default/original/3X/9/8/9883337157127febfc866b16a260d34121894f82.gif",
            shortUrl: "upload://lLbFG6pnpuP84cjrwo2j1pSjJXs.gif",
          },
          {
            name: "高速列车3",
            url: "/uploads/default/original/3X/c/a/cad11bee1a8e30a47560849834005850ccafb7fd.gif",
            shortUrl: "upload://sWcsIBbQh3rPeB8HU4SPyyB7dRr.gif",
          },
          {
            name: "麻将牌发财",
            url: "/uploads/default/original/3X/0/1/01cedb52f84a6b25259c0c365d3732a181078db3.gif",
            shortUrl: "upload://fZFi1R2tsHufrZjiGRtBqk7tfl.gif",
          },
          {
            name: "微信_嘿哈",
            url: "/uploads/default/original/3X/7/e/7e1cebd7ca5b2a3782a4878254af6db247a276a2.png",
            shortUrl: "upload://hZE7JHMc8yJXTzfpw1lZ7jOYBVw.png",
          },
          {
            name: "微信_奸笑",
            url: "/uploads/default/original/3X/c/c/ccb89f2d4640cb2edf28b53b9eb21e31acf6e211.png",
            shortUrl: "upload://td2Xapn2LolcTVcIRsTX0d8X0Hv.png",
          },
          {
            name: "微信_捂脸",
            url: "/uploads/default/original/3X/0/0/004c5bccf651ce624720fa314b8395ec1636300a.png",
            shortUrl: "upload://2DB2W0THffebeoRXMHytb9ui14.png",
          },
          {
            name: "微信_机智",
            url: "/uploads/default/original/3X/f/3/f39250685e9843c60f0249ef4a56cf8d42b88ccd.png",
            shortUrl: "upload://yKJv6YXNLo37FfkHqw03xzPjtut.png",
          },
          {
            name: "微信_皱眉",
            url: "/uploads/default/original/3X/f/9/f9f62fb93b937dee20c4db19b28e12fbaa87c18a.png",
            shortUrl: "upload://zFgld5se00UUmPnluhA0auR1AVA.png",
          },
          {
            name: "微信_耶",
            url: "/uploads/default/original/3X/6/2/629898d457b9f8569405d4c6ac4111661dc3a10b.png",
            shortUrl: "upload://e4dJeLq1OAg1UipcbcJhjg3srkT.png",
          },
        ];
        // cSpell: enable

        if (
          new Set(QQ_EMOJIS_LIST.map((qqEmoji) => qqEmoji.name)).size !==
          QQ_EMOJIS_LIST.length
        ) {
        ...
        qqEmojiEntrypoint.src = QQ_EMOJIS_LIST.find(
          (qqEmoji) => qqEmoji.name === "斜眼笑"
        ).url;
        ...
        qqEmojiDiv.addEventListener("click", (e) => {
          ...
          if (/[\x00-\x1f\x7f\\`()[\]<>&"|*:]|~~/u.test(emojiName)) {
            throw new Error(
              `Cannot insert QQ emoji as name ${emojiName} is unsafe for Markdown`
            );
          }
          // eslint-disable-next-line no-control-regex
          if (/[\x00-\x1f\x7f\\`()[\]<>&"\s]/u.test(emojiShortURL)) {
            throw new Error(
              `Cannot insert QQ emoji as short URL ${emojiShortURL} is unsafe for Markdown`
            );
          }
    ...
    },
    {
      ...
      onMatch: (element, optionValues) => {
        if (
          isElementHandledByFeature(element, "expand-who-liked") ||
          (element
            .closest(".post-menu-area")
            ?.getElementsByClassName("who-liked").length ?? 0) > 0
        ) {
          return;
        }
        markElementHandledByFeature(element, "expand-who-liked");

        const expandWhoLikedInterval = Math.min(
          Math.max(optionValues["expand-interval-ms"], 0),
          60000
        );
        ...
        const expandWhoLikedTask = () => {
          ...
          while (queue.length > 0) {
            ...
            if (document.body.contains(el)) {
              el.click();
              shuiyuanHelperMemory.set(
                "expandWhoLikedTimeoutID",
                setTimeout(expandWhoLikedTask, expandWhoLikedInterval)
              );
              return;
            }
          }
        ...
        if (!shuiyuanHelperMemory.get("expandWhoLikedTimeoutID")) {
          shuiyuanHelperMemory.set(
            "expandWhoLikedTimeoutID",
            setTimeout(expandWhoLikedTask, 0)
          );
        }
      },
    },
    {
      ...
      onMatch: (element) => {
        const addUsernameToWhoLikedItem = (el) => {
          if (
            el.getElementsByClassName("shuiyuan-helper-liked-username").length >
            0
          ) {
            return;
          }
        ...
        const updateUsernameOnWhoLikedItem = (el) => {
          for (const usernameSpan of [
            ...el.getElementsByClassName("shuiyuan-helper-liked-username"),
          ]) {
            usernameSpan.remove();
          }
          ...
          const whoLikedObserver = new MutationObserver((mutationsList) => {
            ...
            for (const mutation of mutationsList) {
              if (mutation.type === "childList") {
                ...
                mutation.attributeName === "data-user-card"
              ) {
    ...
    },
    {
      ...
      onMatch: () => {
        applyHook(
          window.require("discourse/services/store").default.prototype,
          "find",
          (origFunc) =>
            function (type, findArgs, ...args) {
              if (
                type === "post-action-user" &&
                findArgs?.post_action_type_id === 2
              ) {
                const postId = findArgs.id;
                if (Number.isInteger(postId)) {
                  const likeCountElement = document.querySelector(
                    `article[data-post-id="${postId}"] .post-menu-area .like-count`
                  );
                  if (likeCountElement) {
                  ...
                  // eslint-disable-next-line no-console
                  console.error(
                    "discourse/services/store find findArgs.id not an integer"
                  );
                }
              }
    ...
    },
    {
      ...
      onInitialize: (optionValues) => {
        ...
        if (
          !optionValues["show-expand-collapse-button"] &&
          !optionValues["expand-by-default"]
        ) {
          return;
        }
        addGlobalStyle(`
      ...
      onMatch: (element, optionValues) => {
        ...
        const updateRetortContainerClass = (retortContainer) => {
          if (getDataAtElement(retortContainer, "retortUsersExpanded")) {
            retortContainer.classList.remove(
              "shuiyuan-helper-retort-users-collapsed"
            );
          } else {
            retortContainer.classList.add(
              "shuiyuan-helper-retort-users-collapsed"
            );
          }
        };
        ...
        if (!topicArea) return; // 添加 null 检查
        const currentTopicId = parseInt(
          topicArea.getAttribute("data-topic-id"),
          10
        );
        setDataAtElementIfAbsent(topicArea, "retortFetchQueue", []);
        setDataAtElementIfAbsent(topicArea, "retortFetchTimeoutID", null);
        const article = element.closest("article");
        if (!article) return; // 添加 null 检查
        ...
        const generateRetortItem = (retortButton, retortsMap) => {
          ...
          if (shuiyuanHelperMemory.get("hideRetortsOfIgnoredUsers")) {
            const ignoredUsersLowerCaseSet = shuiyuanHelperMemory.get(
              "ignoredUsersLowerCaseSet"
            );
            if (ignoredUsersLowerCaseSet.size > 0) {
              displayUsernames = usernames.filter(
                (u) => !ignoredUsersLowerCaseSet.has(u.toLowerCase())
              );
            }
          }
          ...
          div.addEventListener("click", (e) => {
            ...
            if (
              e.target.matches?.("a") ||
              e.target.parentElement?.matches("a")
            ) {
              return;
            }
          ...
          if (showExpandCollapseButton) {
            if (!retortContainer.shadowRoot) {
              ...
              const updateExpandCollapseButtonState = () => {
                const retortUsersExpanded = getDataAtElement(
                  retortContainer,
                  "retortUsersExpanded"
                );
                expandCollapseButton.innerHTML = retortUsersExpanded
                  ? COLLAPSE_RETORT_USERS_ICON
                  : EXPAND_RETORT_USERS_ICON;
                expandCollapseButton.title = retortUsersExpanded
                  ? "收起贴表情人"
                  : "展开贴表情人";
              };
              ...
              expandCollapseButton.addEventListener("click", (e) => {
                ...
                setDataAtElement(
                  retortContainer,
                  "retortUsersExpanded",
                  !getDataAtElement(retortContainer, "retortUsersExpanded")
                );
              ...
              retortContainer.shadowRoot.appendChild(
                document.createElement("slot")
              );
            }

            const expandCollapseButton =
              retortContainer.shadowRoot.querySelector(
                ".shuiyuan-helper-expand-collapse-retort-users-button"
              );
            expandCollapseButton.style.display =
              retorts.length > 0 ? "" : "none";
          }
        };

        const processRetortUpdateRequests = async () => {
          const retortFetchQueue = getDataAtElement(
            topicArea,
            "retortFetchQueue"
          );
          const postIdsToFetch = retortFetchQueue.splice(
            0,
            RETORT_FETCH_MAX_ENTRIES
          );
          const res = await discourseFetch(
            `/t/${currentTopicId}/posts.json?${postIdsToFetch
              .map((id) => `post_ids%5B%5D=${id}`)
              .join("&")}`
          );
          ...
          for (const post of posts) {
            ...
            const retortContainer = topicArea.querySelector(
              `article[data-post-id="${post.id}"] .post-retort-container`
            );
            if (!retortContainer) {
              continue;
            }
          ...
          setDataAtElement(
            ...
            retortFetchQueue.length > 0
              ? setTimeout(processRetortUpdateRequests, RETORT_FETCH_INTERVAL)
              : null
          );
        };
        ...
        const updateOneRetort = (retortButton) => {
          try {
            ...
            if (
              !document.body.contains(retortButton) ||
              retortButton.closest(".shuiyuan-helper-retort-users")
            ) {
              return;
            }
        ...
        computeDataAtElementIfAbsent(element, "retortObserver", () => {
          const retortObserver = new MutationObserver((mutationsList) => {
            ...
            for (const mutation of mutationsList) {
              if (mutation.type === "childList") {
                for (const node of mutation.addedNodes) {
                  if (
                    isRetortButton(node) &&
                    !node.closest(".shuiyuan-helper-retort-users") &&
                    !getDataAtElement(node, "retortButtonUnwrapped")
                  ) {
            ...
            if (
              ...
              const expandCollapseButton = element.shadowRoot.querySelector(
                ".shuiyuan-helper-expand-collapse-retort-users-button"
              );
    ...
    },
    {
      ...
      onMatch: (element) => {
        ...
        const getAnimationElement = (retortButton) =>
          retortButton.closest(".shuiyuan-helper-retort-users") ?? retortButton;

        element.addEventListener("click", (e) => {
          const clickedNode = e.target;
          const clickedRetortButton = clickedNode.closest
            ? clickedNode.closest(".post-retort")
            : clickedNode.parentElement.closest(".post-retort");
      ...
      onMatch: (element, optionValues) => {
        ...
        const getEmojiURL = (emoji) => {
          try {
            ...
            console.error(e);
            return (
              customEmojisMap.get(emoji) ??
              `/images/emoji/google/${encodeURIComponent(emoji).replaceAll(
                "%3A",
                "/"
              )}.png`
            );
        ...
        const createEmojiSectionButton = (sectionId, emoji) => {
          ...
          button.addEventListener("click", () => {
            const sectionDiv = element.querySelector(
        ...
        const quickAccessList = optionValues["quick-access-emoji-list"]
          .split("|")
          .map((emoji) => emoji.trim())
          .filter(Boolean)
          .filter((emoji) => allEmojiNamesSet.has(emoji));

        const QUICK_ACCESS_SECTION_ID =
          "shuiyuan_helper_quick_access_emoji_list";

        if (
          quickAccessList.length &&
          !element.querySelector(
            `div[data-section="${QUICK_ACCESS_SECTION_ID}"]`
          )
        ) {
          const smileysAndEmotionSection = element.querySelector(
            'div[data-section="smileys_&_emotion"]'
          );
          const smileysAndEmotionSectionButton = element.querySelector(
            'button[data-section="smileys_&_emotion"]'
          );
          if (smileysAndEmotionSection && smileysAndEmotionSectionButton) {
            smileysAndEmotionSection.before(
              createEmojiSection(
                QUICK_ACCESS_SECTION_ID,
                "我的快捷表情",
                quickAccessList
              )
            );
            smileysAndEmotionSectionButton.before(
              createEmojiSectionButton(QUICK_ACCESS_SECTION_ID, "pushpin")
            );
          } else {
            // eslint-disable-next-line no-console
    ...
    },
    {
      ...
      onMatch: async (element) => {
        if (element.matches(".metadata-row")) {
          // User Card
          ...
          const addUserCardDateItem = (container, desc, dateString) => {
            ...
            addUserCardListItem(
              container,
              desc,
              getRelativeDateString(new Date(dateString)),
              dateString
            );
          };
          ...
          const usernamesInClass = [...userCard.classList]
            .filter((c) => c.startsWith("user-card-"))
            .map((c) => c.slice(10));
          if (usernamesInClass.length !== 1) {
            throw new Error(
              `could not determine username from user-card classList: ${userCard.classList}`
            );
          }
          ...
          if (
            !userInfo ||
            isElementHandledByFeature(element, "enhanced-user-card")
          ) {
            return;
          }

          const profileHidden =
            userCard.getElementsByClassName("profile-hidden").length > 0;
          const extraItemsDiv = document.createElement("div");
          extraItemsDiv.classList.add(
            "shuiyuan-helper-user-card-extra-metadata"
          );
          ...
          addUserCardLinkItem(
            extraItemsDiv,
            `/u?name=${encodeURIComponent(username)}&period=all`,
            "统计信息"
          );
          if (!profileHidden) {
            addUserCardLinkItem(
              extraItemsDiv,
              `/u/${encodeURIComponent(username)}/activity`,
              "活动"
            );
          }
          addUserCardLinkItem(
            extraItemsDiv,
            `/search?q=${encodeURIComponent(`user:${username} order:latest`)}`,
            "搜索历史发帖"
          );
          element.appendChild(extraItemsDiv);
          markElementHandledByFeature(element, "enhanced-user-card");
        }
        if (element.matches(".secondary")) {
          // User Page
          const userMain = element.closest(".user-main");
          if (!userMain) {
            return;
          }
          const infoPanelDl = userMain.querySelector(
            "#collapsed-info-panel > dl"
          );
          if (
            !infoPanelDl ||
            isElementHandledByFeature(infoPanelDl, "enhanced-user-card")
          ) {
            return;
          }
          ...
          addUserPageListItem(
            infoPanelDl,
            "生日",
            parseBirthdayMonthDate(userInfo.birthdate)
          );
          addUserPageListItem(infoPanelDl, "时区", userInfo.timezone);
          addUserPageViewJSONRawInfoLink(
            infoPanelDl,
            "查看用户 JSON 原始数据",
    ...
    },
    {
      ...
      onMatch: (element) => {
        ...
        if (
          ...
          element.getElementsByClassName(
            "shuiyuan-helper-post-violation-announcement-parsed-ids"
          ).length > 0
        ) {
          return;
        }

        const findTopicOrPostIdsNodes = () =>
          [...element.children]
        ...
        const getTopicStatuses = async (topicIds) => {
          ...
          for (const topicId of topicIds) {
            promises.push(
              (async () =>
                (
                  await discourseFetch(`/t/${topicId}.json`, null, {
                    expectOkStatus: false,
                  })
                ).json())()
            );
          }
          for (const [topicId, result] of zip(
            topicIds,
        ...
        const updatePostItemState = (slot, topicStatuses) => {
          ...
          const postNumber = slot.hasAttribute("data-post-number")
            ? parseInt(slot.getAttribute("data-post-number"), 10)
            : null;
          ...
          if (topicStatus.accessible) {
            const link = document.createElement("a");
            const postLocation = postNumber
              ? `${topicId}/${postNumber}`
              : topicId.toString();
            link.href = `/t/topic/${postLocation}`;
            link.title = topicStatus.title;
            link.appendChild(
              document.createTextNode(`${postLocation}（${link.title}）`)
            );
            link.addEventListener("click", (e) => {
              if (isOpenInNewTabOrWindow(e)) {
                return;
        ...
        const createInspectButton = (topicOrPostIdsNode) => {
          ...
          const prefixNode = document.createTextNode(
            topicOrPostIdsText.slice(0, colonIndex + 1)
          );
          const topicOrPostIdsContent = topicOrPostIdsText.slice(
            colonIndex + 1
          );
          ...
          inspectButton.addEventListener("click", async () => {
            try {
              ...
              let lastIndex = 0;
              for (const match of topicOrPostIdsContent.matchAll(
                /\d+\/\d+|\d+/gu
              )) {
                const matchText = match[0];
                let matchTopicId, matchPostNumber;
                if (matchText.includes("/")) {
                  [matchTopicId, matchPostNumber] = matchText
                    .split("/")
                    .map((s) => parseInt(s, 10));
                } else {
                ...
                parsedItems.push(
                  topicOrPostIdsContent.slice(lastIndex, matchStartIndex)
                );
                parsedItems.push(
                  createSlotForPostItem(matchTopicId, matchPostNumber)
                );
          ...
          topicOrPostIdsNode.replaceWith(
            prefixNode,
            inspectButton,
            contentNode
          );
    ...
    },
    {
      ...
      onMatch: (element) => {
        ...
        if (
          element.getElementsByClassName(
            "shuiyuan-helper-user-violation-announcement-parsed-duration"
          ).length > 0
        ) {
          return;
        }
        ...
        const getStartYMD = () => {
          const article = element.closest("article");
          const dateSpan =
            article?.querySelector("a.post-date > span") ||
            article?.querySelector(".post-date span") ||
            article?.querySelector("time");
          const dataTime =
            dateSpan?.getAttribute("data-time") ||
            dateSpan?.getAttribute("datetime");
          if (!dataTime) return null;
          const postDate = new Date(
            parseInt(dataTime, 10) || Date.parse(dataTime)
          );
        ...
        const getEndYMD = (durationContent) =>
          durationContent
            .match(/(\d{4})\s*年\s*(\d{1,2})\s*月\s*(\d{1,2})\s*(?:日|号)/u)
            ?.slice(1, 4)
            .map((s) => parseInt(s, 10));

        const getDayDifference = (startYMD, endYMD) =>
          Math.round(
            (new Date(endYMD[0], endYMD[1] - 1, endYMD[2]) -
              new Date(startYMD[0], startYMD[1] - 1, startYMD[2])) /
              DAY_MS
          );

        const findDurationNodes = () =>
          [...element.children]
            .filter((el) => el.matches("p"))
            .flatMap((p) =>
              [...p.childNodes].filter(
        ...
        const updateDurationNode = (durationNode) => {
          ...
          durationDaysSpan.textContent = `（${getDayDifference(
            startYMD,
            endYMD
          )} 天）`;
    ...
    },
    {
      ...
      onMatch: (element) => {
        if (element.matches(".post-stream")) {
          ...
          const topicUpdateCallbackEntries = window.MessageBus.callbacks.filter(
            (cb) => cb?.channel === `/topic/${topicId}`
          );
          if (topicUpdateCallbackEntries.length === 0) {
            throw new Error(
              "Cannot find topic update callback function to hook"
            );
          }
                ...
                (...args) => {
                  ...
                  switch (data?.type) {
                    ...
                    case "destroyed": {
                      ...
                      if (postCookedDiv) {
                        postCookedDiv.style.background =
                          "var(--danger-low-mid)";
              ...
              if (
                ...
                for (const callbackEntry of window.MessageBus.callbacks) {
                  ...
                  if (
                    ...
                    getOrigFunc(callbackEntry.func) === func
                  ) {
                    callbackEntry.func = func;
                  }
                }
    ...
    },
    {
      ...
      onMatch: async (element) => {
        const markTopicOwnerPost = (container) => {
          if (
            container.getElementsByClassName(
              "shuiyuan-helper-topic-owner-posts-marker"
            ).length > 0
          ) {
            return;
          }
          ...
          if (
            ...
            if (
              afterStyle.content &&
              !["none", "normal"].includes(afterStyle.content) &&
        ...
        if (element.matches(".names")) {
          if (
            !element.closest(".topic-post.topic-owner .topic-meta-data") ||
            element.closest(".embedded-reply")
          ) {
            return;
          }
          if (IS_MOBILE_VIEW) {
        ...
        if (element.matches(".embedded-reply")) {
          // This should not happen on mobile view.
          ...
          const markTopicOwnerEmbeddedReply = (el, topicOwnerUsername) => {
            if (typeof topicOwnerUsername !== "string") {
              // eslint-disable-next-line no-console
              console.error(
                "Topic owner username not a string:",
                topicOwnerUsername
              );
              return;
            }
            if (topicOwnerUsername.includes("\x00")) {
              // eslint-disable-next-line no-console
              console.error(
                `Topic owner username contains the null character: ${topicOwnerUsername}`
              );
              return;
            }
            if (
              el.querySelector(
                `a[data-user-card="${CSS.escape(topicOwnerUsername)}" i]`
              )
            ) {
              ...
              if (!namesDiv) {
                // eslint-disable-next-line no-console
                console.error(
                  "Cannot locate .names in .shuiyuan-helper-topic-owner-embedded-reply"
                );
                return;
              }
          ...
          if (!hasDataAtElement(topicArea, "topicOwnerUsername")) {
            ...
            if (getDataAtElement(topicArea, "topicOwnerUsernameBeingFetched")) {
              setDataAtElementIfAbsent(
                topicArea,
                "markTopicOwnerEmbeddedReplyPendingElements",
                []
              ).push(element);
              return;
            }
            ...
            try {
              ...
              const data = await (
                await discourseFetch(`/t/${topicId}.json`)
              ).json();
              topicOwnerUsername =
                data.details?.created_by?.username ??
                data.post_stream.posts[0].username;
            ...
            try {
              for (const el of getDataAtElement(
                topicArea,
                "markTopicOwnerEmbeddedReplyPendingElements"
              ) ?? []) {
          ...
          markTopicOwnerEmbeddedReply(
            element,
            getDataAtElement(topicArea, "topicOwnerUsername")
          );
        }
      },
    },
    {
      ...
      onMatch: (element, optionValues) => {
        ...
        const expandCodeBlocksByDefault =
          optionValues["expand-code-blocks-by-default"];
        ...
        const addPostRawInfoDisplay = async (postCookedDiv, postId) => {
          ...
          const createCodeBlock = async (code, language) => {
            ...
            try {
              ...
              await window
                .require("discourse/lib/highlight-syntax")
                .default(
                  codePre,
          ...
          const addDisplaySection = async (
            ...
            sectionDiv.classList.add(
              "shuiyuan-helper-post-raw-info-display-section"
            );
            if (sectionId) {
          ...
          const addViewJSONRawInfoLink = (container, text, className, url) => {
            ...
            rawInfoLinkDiv.classList.add(
              "shuiyuan-helper-view-json-raw-info-link"
            );
            if (className) {
          ...
          postRawInfoDisplayDiv.classList.add(
            "shuiyuan-helper-post-raw-info-display"
          );

          const closeRawInfoDisplayButton = document.createElement("button");
          closeRawInfoDisplayButton.classList.add(
            "btn-flat",
            "shuiyuan-helper-close-post-raw-info-display-button",
            "no-text",
            "btn-icon",
          ...
          const postInfo = await (
            await discourseFetch(`/posts/${postId}.json`)
          ).json();
          const isTopicFirstPost = postInfo.post_number === 1;
          let topicInfo = null;
          if (isTopicFirstPost) {
            topicInfo = await (
              await discourseFetch(`/t/${postInfo.topic_id}.json`)
            ).json();
          }
          ...
          if (postInfo.hidden) {
            const results = await promiseAllSettledLogErrors([
              (async () =>
                (await discourseFetch(`/posts/${postId}/raw`)).text())(),
              (async () =>
                (
                  await discourseFetch(`/posts/${postId}/cooked.json`)
                ).json())(),
            ]);
          ...
          if (isTopicFirstPost) {
            await addDisplaySection(
              postRawInfoDisplayDiv,
              "话题基本信息",
              "topic-basic-info",
              async (container) => {
                ...
                const hasDifferentHtmlTitle =
                  htmlTitle && htmlTitle !== rawTitle;
                const hasDifferentUnicodeTitle =
                  unicodeTitle && unicodeTitle !== rawTitle;
                const hasDifferentTitleVersions =
                  hasDifferentHtmlTitle || hasDifferentUnicodeTitle;
                addDisplayLine(
                  container,
                  hasDifferentTitleVersions ? "原始标题" : "标题",
                  "title",
                  await createCodeBlock(rawTitle, "text"),
                  { richContent: true, lineBreak: false }
                );
                if (hasDifferentHtmlTitle) {
                  addDisplayLine(
                    ...
                    "HTML 标题",
                    "fancy_title",
                    await createCodeBlock(htmlTitle, "html"),
                    { richContent: true, lineBreak: false }
                  );
                }
                if (hasDifferentUnicodeTitle) {
                  addDisplayLine(
                    ...
                    "Unicode 标题",
                    "unicode_title",
                    await createCodeBlock(unicodeTitle, "text"),
                    { richContent: true, lineBreak: false }
                  );
                }
              }
          ...
          await addDisplaySection(
            ...
            async (container) => {
              addDisplayDetails(
                ...
                "原始内容",
                "raw",
                await createCodeBlock(postInfo.raw, "markdown")
              );
              addDisplayDetails(
                container,
                "构建内容",
                "cooked",
                await createCodeBlock(postInfo.cooked, "html")
              );
              if (postInfo.polls?.length) {
                addDisplayDetails(
                  ...
                  await createCodeBlock(
                    JSON.stringify(postInfo.polls, null, 4),
                    "json"
                  )
                );
              }
          ...
          if (isTopicFirstPost) {
            await addDisplaySection(
              ...
              (container) => {
                if (topicInfo.closed) {
                  addDisplayLine(container, "话题已被关闭", "closed", null, {
                    descOnly: true,
                  });
                }
                if (topicInfo.archived) {
                  addDisplayLine(container, "话题已被归档", "archived", null, {
                    descOnly: true,
                  });
                }
          ...
          await addDisplaySection(
            ...
            (container) => {
              ...
              if (postInfo.hidden) {
                addDisplayLine(container, "帖子已被举报隐藏", "hidden", null, {
                  descOnly: true,
                });
                addDisplayLine(
                  container,
                  "隐藏原因",
                  "hidden_reason_id",
                  hiddenReasonsMap.get(postInfo.hidden_reason_id) ??
                    postInfo.hidden_reason_id
                );
              }
            }
          );
            ...
            await addDisplaySection(
              ...
              (container) => {
                addDisplayLine(
                  ...
                  "总楼层数",
                  "highest_post_number",
                  topicInfo.highest_post_number
                );
                addDisplayLine(
                  container,
                  "有效楼层数",
                  "posts_count",
                  topicInfo.posts_count
                );
              }
            );
          }
          ...
          if (isTopicFirstPost) {
            addViewJSONRawInfoLink(
              postRawInfoDisplayDiv,
              "查看话题 JSON 原始数据",
              "view-topic-json",
              `/t/${postInfo.topic_id}.json`
            );
          }
          addViewJSONRawInfoLink(
            postRawInfoDisplayDiv,
            "查看帖子 JSON 原始数据",
            "view-post-json",
            `/posts/by_number/${postLocation}.json`
          );
          ...
          try {
            const CodeblockButtons = window.require(
              "discourse/lib/codeblock-buttons"
            ).default;
        ...
        if (!element.shadowRoot) {
          ...
          toggleShowPostRawInfoButton.classList.add(
            "widget-button",
            "btn-flat",
            "shuiyuan-helper-toggle-show-post-raw-info-button",
            "no-text",
          ...
          toggleShowPostRawInfoButton.addEventListener("click", async () => {
            ...
            try {
              ...
              const existingPostRawInfoDisplay =
                postCookedDiv.getElementsByClassName(
                  "shuiyuan-helper-post-raw-info-display"
                )[0];
              if (existingPostRawInfoDisplay) {
                existingPostRawInfoDisplay.remove();
              } else {
                await addPostRawInfoDisplay(
                  postCookedDiv,
                  parseInt(article.getAttribute("data-post-id"), 10)
                );
              }
            } catch (e) {
              // eslint-disable-next-line no-console
    ...
    },
    {
      ...
      onMatch: () => {
        const updateOnlineUserCountText = (
          el,
          onlineUserCount,
          lastUpdated
        ) => {
          ...
          el.setAttribute(
            "data-shuiyuan-helper-online-user-count",
            onlineUserCountText
          );
          el.setAttribute(
            "data-shuiyuan-helper-online-user-count-last-updated",
            `（更新于 ${hh}:${mm}:${ss}）`
          );
        };
        ...
        const fetchAndUpdateOnlineUserCount = async () => {
          ...
          shuiyuanHelperMemory.set(
            "onlineUserCountUpdateTimeoutID",
            setTimeout(
              fetchAndUpdateOnlineUserCount,
              UPDATE_ONLINE_USER_COUNT_INTERVAL
            )
          );
          shuiyuanHelperMemory.set(
            "onlineUserCountUpdateScheduled",
            new Date()
          );
        };
        ...
        const startUpdateOnlineUserCount = () => {
          ...
          const onlineUserCountUpdateTimeoutID = shuiyuanHelperMemory.get(
            "onlineUserCountUpdateTimeoutID"
          );
          if (onlineUserCountUpdateTimeoutID) {
            const onlineUserCountUpdateScheduled = shuiyuanHelperMemory.get(
              "onlineUserCountUpdateScheduled"
            );
            if (
              onlineUserCountUpdateScheduled &&
              new Date() - onlineUserCountUpdateScheduled <=
                UPDATE_ONLINE_USER_COUNT_INTERVAL * 1.5
            ) {
          ...
          shuiyuanHelperMemory.set(
            "onlineUserCountUpdateTimeoutID",
            setTimeout(fetchAndUpdateOnlineUserCount, 0)
          );
          shuiyuanHelperMemory.set(
            "onlineUserCountUpdateScheduled",
            new Date()
        ...
        if (
          !shuiyuanHelperMemory.has("onlineUserCountVisibilityChangeListener")
        ) {
          ...
          document.addEventListener(
            "visibilitychange",
            onlineUserCountVisibilityChangeListener
          );
          shuiyuanHelperMemory.set(
            "onlineUserCountVisibilityChangeListener",
            onlineUserCountVisibilityChangeListener
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          instructions:
            "将同时用于 @system 用户的头像及站点的 favicon。建议为正方形。仅支持水源站内链接或 Data URL。",
          type: "string",
          defaultValue: "",
        },
      ],
      ...
      onInitialize: (optionValues) => {
        ...
        for (const [optionId, memoryCacheKey] of logoConfigFields) {
          ...
          try {
            ...
            if (!["https:", "http:", "data:"].includes(logoURL.protocol)) {
              throw new Error(
                `Unsupported protocol for ${optionId}: ${logoURL.protocol}`
              );
            }
            if (
              optionId === "small-logo-url" &&
              logoURL.protocol !== "data:" &&
              logoURL.origin !== window.location.origin
            ) {
              throw new Error(
                "Cross-origin URL is not supported for small-logo-url"
              );
            }
        ...
        const siteSmallLogoReplacementURL = shuiyuanHelperMemory.get(
          "siteSmallLogoReplacementURL"
        );
      ...
      onMatch: (element) => {
          ...
          if (firefoxWorkaround) {
            setTimeout(() => {
              ...
              if (
                ...
                img.matches(".shuiyuan-helper-replace-site-logo")
              ) {
                img.src = url;
              }
            }, 200);
        ...
        const siteBigLogoReplacementURL = shuiyuanHelperMemory.get(
          "siteBigLogoReplacementURL"
        );
        const siteSmallLogoReplacementURL = shuiyuanHelperMemory.get(
          "siteSmallLogoReplacementURL"
        );
        ...
        const logoHandlerFields = [
          ...
          [
            "picture > #site-logo:not(.logo-big, .logo-small, .logo-mobile)",
            siteBigLogoReplacementURL,
          ], // Logo on error pages
        ];
        for (const [selector, replacementURL] of logoHandlerFields) {
          if (replacementURL && element.matches(selector)) {
            ...
            replaceImageURL(
              element,
              replacementURL,
              IS_FIREFOX && replacementURL === siteBigLogoReplacementURL
            );
          }
        }
        ...
        if (siteSmallLogoReplacementURL && element.matches("img.avatar")) {
          if (
            ...
            (element.title === "system" &&
              element.closest(".user-result, .search-item-user")) ||
            (element.closest(".user-main .user-profile-avatar") &&
              findUsernameInUserPage(element.closest(".user-main")) ===
                "system") ||
            (element.closest(".autocomplete.ac-user") &&
              findUsernameInACUserItem(element.parentElement) === "system") ||
            (element.closest("aside.quote > .title") &&
              element.src &&
              !element.src.includes("avatar")) ||
            ["system", "@system"].includes(
              findUsernameInUserOnebox(element.closest(".user-onebox"))
            )
          ) {
        ...
        if (IS_DISCOURSE_VIEW && siteSmallLogoReplacementURL) {
          ...
          if (!shuiyuanHelperMemory.get("siteSettingsSmallLogoReplaced")) {
            ...
            try {
              ...
              ).site_logo_small_url = siteSmallLogoReplacementURL;
            } catch (e) {
              // eslint-disable-next-line no-console
              console.error(e);
            }
          ...
          if (!shuiyuanHelperMemory.get("updateTabCountHooked")) {
            ...
            try {
              applyHook(
                window.require("discourse/lib/update-tab-count"),
                "default",
                (origFunc) => (url, count) => {
    ...
    },
    {
      ...
      description: "进一步增强屏蔽",
      instructions:
        "在回复列表、引用内容和频繁发帖人列表中隐藏被屏蔽的用户及其内容",
      group: "read-content",
      enabledByDefault: false,
      ...
      onMatch: (element) => {
        ...
        if (element.matches(".poster")) {
          ...
          if (
            shuiyuanHelperMemory
              .get("ignoredUsersLowerCaseSet")
              .has(element.getAttribute("data-user-card")?.toLowerCase())
          ) {
            element.style.display = "none";
          }
        }
    ...
    },
    {
      ...
      onMatch: (element) => {
        if (
          element.classList.contains("math-container,block-math,mathjax-math")
        ) {
        ...
        if (
          element.classList.contains("math-container,inline-math,mathjax-math")
        ) {
        ...
        if (
          element.classList.contains("math-container,inline-math,ascii-math")
        ) {
    ...
    },
    {
      ...
      onMatch: (element) => {
        ...
        if (
          element.getElementsByClassName("user-nav__preferences-account")
            .length === 0
        ) {
          return;
        }
        ...
        const createIntegerInputDiv = (
          ...
          input.addEventListener(
            "input",
            debounce(inputHandler, INPUT_DEBOUNCE_INTERVAL)
          );
        ...
        const isLiMatchingCurrentPath = (li) =>
          new URL(li.firstElementChild.href).pathname.toLowerCase() ===
          window.location.pathname.toLowerCase();

        const liContainer = element.getElementsByClassName("nav-pills")[0];
        if (!liContainer) {
          throw new Error(
            "Cannot locate Shuiyuan Helper settings view insertion point"
          );
        }
        ...
        shuiyuanHelperLink.addEventListener("click", (e0) => {
          ...
          for (const group of ALL_FEATURE_GROUPS) {
            const controlGroup = createFieldset(
              group.description,
              `shuiyuan-helper-feature-group-${group.id}`
            );
                    ...
                    case "boolean":
                      controlGroup.appendChild(
                        createCheckboxDiv(
                          ...
                          (e) => {
                            const config = loadConfig();
                            config[featureId] = fixOptionObject(
                              config[featureId]
                            );
          ...
          reloadDiv.classList.add(
            "control-group",
            "shuiyuan-helper-settings-reload-apply-changes"
          );
          ...
          const reloadInstructions = createInstructionsDiv(
            "点击按钮或刷新页面，以应用对水源助手设置的更改。"
          );
          reloadDiv.appendChild(reloadInstructions);
          shuiyuanHelperSettingsDiv.appendChild(reloadDiv);

          const importExportControlGroup = createFieldset(
            "导入/导出",
            "shuiyuan-helper-settings-import-export"
          );
          const notesLabel = document.createElement("label");
          notesLabel.textContent =
            "水源助手设置仅保存在本地设备，不会通过您的帐户进行同步。";
          importExportControlGroup.appendChild(notesLabel);
          const exportDiv = document.createElement("div");
          const exportToFileButton = createButton(
            "导出到文件",
            DOWNLOAD_ICON,
            "btn-default",
            () =>
              createFileDownload(
                ...
                `shuiyuan-helper-config-${new Date()
                  .toISOString()
                  .replaceAll(/[:.]/gu, "-")}.json`,
                "application/json"
              )
          ...
          const exportToClipboardButton = createButton(
            "导出到剪贴板",
            COPY_ICON,
            "btn-default",
            async () => {
              ...
              exportToClipboardStatus.textContent = copySuccessful
                ? "已复制到剪贴板"
                : "无法复制到剪贴板";
              exportToClipboardStatus.style.color = copySuccessful
                ? "var(--success)"
                : "var(--danger)";
          ...
          importFromTextInput.classList.add(
            "input-xxlarge",
            "ember-text-field",
            "ember-view"
          );
          importFromTextInput.type = "text";
          importFromTextInput.placeholder =
            IS_MOBILE_VIEW || IS_MOBILE_DEVICE
              ? "在此粘贴要导入的设置文本"
              : "在此粘贴要导入的设置文本，或拖放设置文件到此处以导入";
          ...
          const importConfigText = (content) => {
            ...
            if (
              ...
              !confirm(
                "导入的设置为空设置，这将会重置水源助手设置为默认值，是否继续？"
              )
            ) {
              return;
            }
          ...
          fileInput.addEventListener("change", () =>
            importConfigFileHandler(fileInput.files[0], fileInput)
          );
          const importFromFileButton = createButton(
            "从文件导入",
            UPLOAD_ICON,
            "btn-default",
            () => fileInput.click()
          ...
          const importFromTextButton = createButton(
            "导入上述文本",
            PASTE_ICON,
            "btn-default",
            () => {
          ...
          if (window.location.hash !== SETTINGS_VIEW_FRAGMENT) {
            window.history.pushState(
              {},
              "",
              `${window.location.pathname}${SETTINGS_VIEW_FRAGMENT}`
            );
          }
        });
        const popStateListener = () => {
        ...
        shuiyuanHelperLi.classList.add(
          "user-nav__preferences-shuiyuan-helper",
          "ember-view"
        );
        ...
        const resetPrefPage = (e) => {
          ...
          const clickedNode = e.target;
          const clickedLi = clickedNode.closest
            ? clickedNode.closest("li")
            : clickedNode.parentElement.closest("li");
          ...
          if (
            window.location.hash === SETTINGS_VIEW_FRAGMENT &&
            isLiMatchingCurrentPath(clickedLi)
          ) {
    ...
    },
    {
      ...
      onMatch: (element) => {
        if (
          isElementHandledByFeature(element, "fix-default-preferences-buttons")
        ) {
          return;
        }
        ...
        if (element.matches("#quick-access-profile")) {
          ...
          preferencesButton = element.getElementsByClassName(
        ...
        preferencesButton.addEventListener("click", (e) => {
          ...
          e.preventDefault();
          e.stopPropagation();
          const navAccountLi = document.getElementsByClassName(
      ...
      onMatch: (element) => {
        ...
        addLiToSidebarSection(
          ...
          (e) => {
            ...
            e.preventDefault();
            const shuiyuanHelperLink = document.getElementById(
              "nav-shuiyuan-helper"
            );
  ...
  const FEATURE_FIELDS_SET = new Set([
    "id",
    "description",
    "instructions",
    "group",
  ...
  for (const feature of ALL_FEATURES) {
    ...
    if (typeof feature.description !== "string" || !feature.description) {
      throw new Error(
        `Missing or invalid description for feature ${feature.id}`
      );
    }
    if (
      feature.instructions !== undefined &&
      typeof feature.instructions !== "string"
    ) {
    ...
    if (
      !(feature.hidden ? [undefined, false, true] : [false, true]).includes(
        feature.enabledByDefault
      )
    ) {
      throw new Error(
        `Missing or invalid 'enabledByDefault' value for feature ${feature.id}`
      );
    }
    if (feature.options !== undefined) {
      ...
      for (const option of feature.options) {
        ...
        if (
          ...
          console.error(option);
          throw new Error(
            `Option ID missing or invalid in feature ${feature.id}`
          );
        }
        feature.allOptionIds.add(option.id);
        if (typeof option.description !== "string" || !option.description) {
          throw new Error(
            `Missing or invalid description for option ${option.id} of feature ${feature.id}`
          );
        }
        if (
          option.instructions !== undefined &&
          typeof option.instructions !== "string"
        ) {
          throw new Error(
            `Invalid instructions for option ${option.id} of feature ${feature.id}`
          );
        }
        switch (option.type) {
          case "boolean":
            if (![false, true].includes(option.defaultValue)) {
              throw new Error(
                `Missing or invalid default value for option ${option.id} of feature ${feature.id}`
              );
            }
            break;
          case "integer":
          ...
          default:
            throw new Error(
              `Missing or invalid option type for option ${option.id} of feature ${feature.id}`
            );
        }
        const unrecognizedFields = setDifference(
          new Set(Object.keys(option)),
          OPTION_FIELDS_SET
        );
        if (unrecognizedFields.size > 0) {
          // eslint-disable-next-line no-console
          console.error(unrecognizedFields);
          throw new Error(
            `Option ${option.id} of feature ${feature.id} contains unrecognized fields`
          );
        }
      }
      ...
      const allOptionDescriptions = new Set(
        feature.options.map((o) => o.description)
      );
      if (allOptionDescriptions.size !== feature.options.length) {
        throw new Error(
          `Duplicate option descriptions found for feature ${feature.id}`
        );
      }
    }
    ...
    for (const field of MATCH_SPEC_FIELDS) {
      ...
      if (
        Array.isArray(feature[field]) &&
        feature[field].every((x) => typeof x === "string" && x)
      ) {
        continue;
      }
      throw new Error(`Invalid '${field}' value for feature ${feature.id}`);
    ...
    if (hasMatchSpec && !feature.onMatch) {
      throw new Error(
        `Feature ${feature.id} has match specifications but missing onMatch function`
      );
    }
    if (!hasMatchSpec && feature.onMatch) {
      throw new Error(
        `Feature ${feature.id} has onMatch function but missing match specifications`
      );
    }
    if (!hasAction) {
      throw new Error(
        `Feature ${feature.id} missing actions (onMatch or onInitialize)`
      );
    }
    const unrecognizedFields = setDifference(
      new Set(Object.keys(feature)),
      FEATURE_FIELDS_SET
    );
    if (unrecognizedFields.size > 0) {
      // eslint-disable-next-line no-console
  ...
  const allFeatureDescriptions = new Set(
    ALL_FEATURES.map((f) => f.description)
  );
  ...
  for (const feature of ALL_FEATURES) {
    ...
    if (feature.options) {
      ...
      feature.enabled = Boolean(
        optionValues.enabled ?? feature.enabledByDefault
      );
      for (const option of feature.options) {
        ...
        switch (type) {
          case "boolean":
            ...
            break;
          case "integer":
            optionValues[id] = parseIntegerOption(
              optionValues[id],
              defaultValue
            );
            break;
          case "string":
            optionValues[id] = parseStringOption(
              optionValues[id],
              defaultValue
            );
            break;
    ...
    try {
      initExecutePromises.push(
        Promise.resolve(feature.onInitialize?.(feature.optionValues))
      );
    } catch (e) {
      // eslint-disable-next-line no-console
      console.error(e);
  ...
  const handleNewElement = async (element, args) => {
    ...
    if (addedId && addedClasses) {
      throw new Error(
        "Cannot specify both addedId and addedClasses, invoke handleNewElement twice instead"
      );
    }
    ...
    for (const feature of ALL_FEATURES) {
      ...
      if (testElement.matches(feature.selector)) {
        try {
          promises.push(
            Promise.resolve(feature.onMatch(element, feature.optionValues))
          );
        } catch (e) {
          // eslint-disable-next-line no-console
          console.error(e);
      ...
      if (mutation.type === "childList") {
        ...
        switch (mutation.attributeName) {
          ...
          case "class": {
            ...
            const addedClasses = setDifference(
              new Set(mutation.target.classList),
              new Set(dummyElementOfClasses(mutation.oldValue ?? "").classList)
            );
            if (setsOverlap(observeClassesSet, addedClasses)) {
              promises.push(
                handleNewElement(mutation.target, { addedClasses })
              );
            }
            break;
          }
  ...
  if (
    observeTagsSet.size === 0 &&
    observeIdsSet.size === 0 &&
    observeClassesSet.size === 0
  ) {
    // eslint-disable-next-line no-console
    console.warn(
      "No elements to observe! Shuiyuan Helper would perform no action."
    );
    return;
  }
  ...
  globalObserver.observe(document.documentElement, {
    ...
    attributeFilter: shouldObserveAttributes
